if (!function (e, t) {
        ...
        function s() {
            me.addEventListener ? (me.removeEventListener("DOMContentLoaded", o, !1), e.removeEventListener("load", o, !1)) : (me.detachEvent("onreadystatechange", o), e.detachEvent("onload", o))
        }
        ...
        function p(e, t, n, i) {
            if (re.acceptData(e)) {
                ...
                if (d && l[d] && (i || l[d].data) || void 0 !== n || "string" != typeof t) return d || (d = o ? e[s] = V.pop() || re.guid++ : s), l[d] || (l[d] = o ? {} : {toJSON: re.noop}), ("object" == typeof t || "function" == typeof t) && (i ? l[d] = re.extend(l[d], t) : l[d].data = re.extend(l[d].data, t)), r = l[d], i || (r.data || (r.data = {}), r = r.data), void 0 !== n && (r[re.camelCase(t)] = n), "string" == typeof t ? (a = r[t], null == a && (a = r[re.camelCase(t)])) : a = r, a
            }
        }
        ...
        function u(e, t, n) {
            if (re.acceptData(e)) {
                ...
                if (s[o]) {
                    ...
                    (n || (delete s[o].data, d(s[o]))) && (r ? re.cleanData([e], !0) : ie.deleteExpando || s != s.window ? delete s[o] : s[o] = null)
                }
            }
        }
        ...
        function g(e, t) {
            ...
            if (!r) for (r = [], n = e.childNodes || e; null != (i = n[a]); a++) !t || re.nodeName(i, t) ? r.push(i) : re.merge(r, g(i, t));
        ...
        function T(e, t) {
            if (1 === t.nodeType && re.hasData(e)) {
                ...
                if (o) {
                    ...
                    for (n in o) for (i = 0, a = o[n].length; a > i; i++) re.event.add(t, n, o[n][i])
                }
        ...
        function E(e) {
            var t = me, n = et[e];
            return n || (n = S(e, t), "none" !== n && n || (Ze = (Ze || re("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (Ze[0].contentWindow || Ze[0].contentDocument).document, t.write(), t.close(), n = S(e, t), Ze.detach()), et[e] = n), n
        }
        ...
        function M(e, t) {
            if (t in e) return t;
            for (var n = t.charAt(0).toUpperCase() + t.slice(1), i = t, a = ht.length; a--;) if (t = ht[a] + n, t in e) return t;
            return i
        }

        function z(e, t) {
            for (var n, i, a, r = [], s = 0, o = e.length; o > s; s++) i = e[s], i.style && (r[s] = re._data(i, "olddisplay"), n = i.style.display, t ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && De(i) && (r[s] = re._data(i, "olddisplay", E(i.nodeName)))) : r[s] || (a = De(i), (n && "none" !== n || !a) && re._data(i, "olddisplay", a ? n : re.css(i, "display"))));
        ...
        function N(e, t, n, i, a) {
            for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += re.css(e, n + ze[r], !0, a)), i ? ("content" === n && (s -= re.css(e, "padding" + ze[r], !0, a)), "margin" !== n && (s -= re.css(e, "border" + ze[r] + "Width", !0, a))) : (s += re.css(e, "padding" + ze[r], !0, a), "padding" !== n && (s += re.css(e, "border" + ze[r] + "Width", !0, a)));
            return s
        }

        function L(e, t, n) {
            var i = !0, a = "width" === t ? e.offsetWidth : e.offsetHeight, r = tt(e),
                s = ie.boxSizing() && "border-box" === re.css(e, "boxSizing", !1, r);
            if (0 >= a || null == a) {
                if (a = nt(e, t, r), (0 > a || null == a) && (a = e.style[t]), at.test(a)) return a;
                i = s && (ie.boxSizingReliable() || a === e.style[t]), a = parseFloat(a) || 0
            }
        ...
        function $(e, t) {
            ...
            for (t = t ? 1 : 0; 4 > a; a += 2 - t) n = ze[a], i["margin" + n] = i["padding" + n] = e;
            return t && (i.opacity = i.width = e), i
        }

        function I(e, t, n) {
            for (var i, a = (bt[t] || []).concat(bt["*"]), r = 0, s = a.length; s > r; r++) if (i = a[r].call(n, t, e)) return i
        }

        function H(e, t, n) {
            var i, a, r, s, o, l, d, p, u = this, c = {}, h = e.style, f = e.nodeType && De(e), m = re._data(e, "fxshow");
            n.queue || (o = re._queueHooks(e, "fx"), null == o.unqueued && (o.unqueued = 0, l = o.empty.fire, o.empty.fire = function () {
                o.unqueued || l()
            }), o.unqueued++, u.always(function () {
                u.always(function () {
                    o.unqueued--, re.queue(e, "fx").length || o.empty.fire()
                })
            })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], d = re.css(e, "display"), p = E(e.nodeName), "none" === d && (d = p), "inline" === d && "none" === re.css(e, "float") && (ie.inlineBlockNeedsLayout && "inline" !== p ? h.zoom = 1 : h.display = "inline-block")), n.overflow && (h.overflow = "hidden", ie.shrinkWrapBlocks() || u.always(function () {
            ...
            if (!re.isEmptyObject(c)) {
                ...
                for (i in c) s = I(f ? m[i] : 0, i, u), i in m || (m[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
            }
        }

        function O(e, t) {
            var n, i, a, r, s;
            for (n in e) if (i = re.camelCase(n), a = t[i], r = e[n], re.isArray(r) && (a = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), s = re.cssHooks[i], s && "expand" in s) {
        ...
        function _(e, t, n) {
            var i, a, r = 0, s = wt.length, o = re.Deferred().always(function () {
                ...
                if (a) return !1;
                for (var t = ft || A(), n = Math.max(0, d.startTime + d.duration - t), i = n / d.duration || 0, r = 1 - i, s = 0, l = d.tweens.length; l > s; s++) d.tweens[s].run(r);
            ...
            for (O(p, d.opts.specialEasing); s > r; r++) if (i = wt[r].call(d, e, p, d.opts)) return i;
            return re.map(p, I, d), re.isFunction(d.opts.start) && d.opts.start.call(e, d), re.fx.timer(re.extend(l, {
                elem: e,
                anim: d,
                queue: d.opts.queue
        ...
        function B(e) {
            return function (t, n) {
                ...
                if (re.isFunction(n)) for (; i = r[a++];) "+" === i.charAt(0) ? (i = i.slice(1) || "*", (e[i] = e[i] || []).unshift(n)) : (e[i] = e[i] || []).push(n)
            }
        }
        ...
        function j(e, t, n, i) {
            function a(o) {
                var l;
                return r[o] = !0, re.each(e[o] || [], function (e, o) {
                    var d = o(t, n, i);
        ...
        function F(e, t, n, i) {
            ...
            if (p[1]) for (s in e.converters) d[s.toLowerCase()] = e.converters[s];
            for (r = p.shift(); r;) if (e.responseFields[r] && (n[e.responseFields[r]] = t), !l && i && e.dataFilter && (t = e.dataFilter(t, e.dataType)), l = r, r = p.shift()) if ("*" === r) r = l; else if ("*" !== l && l !== r) {
                if (s = d[l + " " + r] || d["* " + r], !s) for (a in d) if (o = a.split(" "), o[1] === r && (s = d[l + " " + o[0]] || d["* " + o[0]])) {
                    s === !0 ? s = d[a] : d[a] !== !0 && (r = o[0], p.unshift(o[1]));
                    break
                }
        ...
        function R(e, t, n, i) {
            ...
            }); else if (n || "object" !== re.type(t)) i(e, t); else for (a in t) R(e + "[" + a + "]", t[a], n, i)
        }
    ...
    var V = [], U = V.slice, Q = V.concat, K = V.push, J = V.indexOf, Z = {}, ee = Z.toString, te = Z.hasOwnProperty,
        ne = "".trim, ie = {}, ae = "1.11.0", re = function (e, t) {
            return new re.fn.init(e, t)
        }, se = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, oe = /^-ms-/, le = /-([\da-z])/gi, de = function (e, t) {
            return t.toUpperCase()
        };
    re.fn = re.prototype = {
        jquery: ae, constructor: re, selector: "", length: 0, toArray: function () {
            return U.call(this)
        }, get: function (e) {
        ...
        for ("boolean" == typeof s && (d = s, s = arguments[o] || {}, o++), "object" == typeof s || re.isFunction(s) || (s = {}), o === l && (s = this, o--); l > o; o++) if (null != (a = arguments[o])) for (i in a) e = s[i], n = a[i], s !== n && (d && n && (re.isPlainObject(n) || (t = re.isArray(n))) ? (t ? (t = !1, r = e && re.isArray(e) ? e : []) : r = e && re.isPlainObject(e) ? e : {}, s[i] = re.extend(d, r, n)) : void 0 !== n && (s[i] = n));
        return s
    }, re.extend({
        expando: "jQuery" + (ae + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            throw new Error(e)
        }, noop: function () {
            ...
            if (i) {
                if (o) for (; s > r && (a = t.apply(e[r], i), a !== !1); r++) ; else for (r in e) if (a = t.apply(e[r], i), a === !1) break
            } else if (o) for (; s > r && (a = t.call(e[r], r, e[r]), a !== !1); r++) ; else for (r in e) if (a = t.call(e[r], r, e[r]), a === !1) break;
            return e
            ...
            if (o) for (; s > r; r++) a = t(e[r], r, i), null != a && l.push(a); else for (r in e) a = t(e[r], r, i), null != a && l.push(a);
            return Q.apply([], l)
        }, guid: 1, proxy: function (e, t) {
            var n, i, a;
            return "string" == typeof t && (a = e[t], t = e, e = a), re.isFunction(e) ? (n = U.call(arguments, 2), i = function () {
    ...
    var pe = function (e) {
        function t(e, t, n, i) {
            ...
            if ((t ? t.ownerDocument || t : j) !== P && L(t), t = t || P, n = n || [], !e || "string" != typeof e) return n;
            if (1 !== (o = t.nodeType) && 9 !== o) return [];
            if ($ && !i) {
                if (a = ye.exec(e)) if (s = a[1]) {
                    if (9 === o) {
                    ...
                    if ((s = a[3]) && C.getElementsByClassName && t.getElementsByClassName) return Z.apply(n, t.getElementsByClassName(s)), n
                }
                if (C.qsa && (!I || !I.test(e))) {
                    if (f = u = B, m = t, g = 9 === o && e, 1 === o && "object" !== t.nodeName.toLowerCase()) {
                        for (d = c(e), (u = t.getAttribute("id")) ? f = u.replace(be, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", l = d.length; l--;) d[l] = f + h(d[l]);
                        m = we.test(e) && p(t.parentNode) || t, g = d.join(",")
                    }
                    if (g) try {
        ...
        function c(e, n) {
            ...
            for (o = e, l = [], d = S.preFilter; o;) {
                (!i || (a = de.exec(o))) && (a && (o = o.slice(a[0].length) || o), l.push(r = [])), i = !1, (a = pe.exec(o)) && (i = a.shift(), r.push({
                    value: i,
                    type: a[0].replace(le, " ")
                }), o = o.slice(i.length));
                for (s in S.filter) !(a = fe[s].exec(o)) || d[s] && !(a = d[s](a)) || (i = a.shift(), r.push({
                    value: i,
                    type: s,
                    matches: a
                }), o = o.slice(i.length));
        ...
        function f(e, t, n) {
            ...
            return t.first ? function (t, n, r) {
                ...
                if (s) {
                    ...
                    if (l = t[B] || (t[B] = {}), (o = l[i]) && o[0] === X && o[1] === r) return d[2] = o[2];
        ...
        function v(e, t, n, a, r, s) {
            return a && !a[B] && (a = v(a)), r && !r[B] && (r = v(r, s)), i(function (i, s, o, l) {
                var d, p, u, c = [], h = [], f = s.length, m = i || b(t || "*", o.nodeType ? [o] : o, []),
                    v = !e || !i && t ? m : g(m, c, e, o, l), y = n ? r || (i ? e : f || a) ? [] : s : v;
                if (n && n(v, y, o, l), a) for (d = g(y, h), a(d, [], o, l), p = d.length; p--;) (u = d[p]) && (y[h[p]] = !(v[h[p]] = u));
                if (i) {
                    if (r || e) {
                        if (r) {
                            for (d = [], p = y.length; p--;) (u = y[p]) && d.push(v[p] = u);
                            r(null, y = [], d, l)
                        }
                        for (p = y.length; p--;) (u = y[p]) && (d = r ? te.call(i, u) : c[p]) > -1 && (i[d] = !(s[d] = u))
                    }
                } else y = g(y === s ? y.splice(f, y.length) : y), r ? r(null, s, y, l) : Z.apply(s, y)
            })
        }
        ...
        function y(e) {
            ...
            }]; a > o; o++) if (n = S.relative[e[o].type]) p = [f(m(p), n)]; else {
                if (n = S.filter[e[o].type].apply(null, e[o].matches), n[B]) {
                    for (i = ++o; a > i && !S.relative[e[i].type]; i++) ;
                    return v(o > 1 && m(p), o > 1 && h(e.slice(0, o - 1).concat({value: " " === e[o - 2].type ? "*" : ""})).replace(le, "$1"), n, i > o && y(e.slice(o, i)), a > i && y(e = e.slice(i)), a > i && h(e))
                }
                p.push(n)
            }
            return m(p)
        ...
        function w(e, n) {
            var a = n.length > 0, r = e.length > 0, s = function (i, s, o, l, d) {
                var p, u, c, h = 0, f = "0", m = i && [], v = [], y = z, w = i || r && S.find.TAG("*", d),
                    b = X += null == y ? 1 : Math.random() || .1, x = w.length;
                for (d && (z = s !== P && s); f !== x && null != (p = w[f]); f++) {
                    if (r && p) {
                        for (u = 0; c = e[u++];) if (c(p, s, o)) {
                            l.push(p);
                            break
                        }
                        d && (X = b)
                    }
                    a && ((p = !c && p) && h--, i && m.push(p))
                }
                if (h += f, a && f !== h) {
                    for (u = 0; c = n[u++];) c(m, v, s, o);
                    if (i) {
        ...
        function x(e, t, n, i) {
            var a, r, s, o, l, d = c(e);
            if (!i && 1 === d.length) {
                if (r = d[0] = d[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && C.getById && 9 === t.nodeType && $ && S.relative[r[1].type]) {
                    if (t = (S.find.ID(s.matches[0].replace(xe, Te), t) || [])[0], !t) return n;
                    e = e.slice(r.shift().value.length)
                }
                for (a = fe.needsContext.test(e) ? 0 : r.length; a-- && (s = r[a], !S.relative[o = s.type]);) if ((l = S.find[o]) && (i = l(s.matches[0].replace(xe, Te), we.test(r[0].type) && p(t.parentNode) || t))) {
                    if (r.splice(a, 1), e = i.length && h(r), !e) return Z.apply(n, i), n;
                    break
                }
            }
            return M(e, d)(i, t, !$, n, we.test(e) && p(t.parentNode) || t), n
        }

        var T, C, S, E, k, M, z, D, N, L, P, A, $, I, H, O, _, B = "sizzle" + -new Date, j = e.document, X = 0, W = 0,
            F = n(), R = n(), q = n(), Y = function (e, t) {
                return e === t && (N = !0), 0
            }, G = "undefined", V = 1 << 31, U = {}.hasOwnProperty, Q = [], K = Q.pop, J = Q.push, Z = Q.push, ee = Q.slice,
            te = Q.indexOf || function (e) {
                for (var t = 0, n = this.length; n > t; t++) if (this[t] === e) return t;
                return -1
            },
            ne = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",
            ie = "[\\x20\\t\\r\\n\\f]", ae = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", re = ae.replace("w", "w#"),
            se = "\\[" + ie + "*(" + ae + ")" + ie + "*(?:([*^$|!~]?=)" + ie + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + re + ")|)|)" + ie + "*\\]",
            oe = ":(" + ae + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + se.replace(3, 8) + ")*)|.*)\\)|)",
            le = new RegExp("^" + ie + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ie + "+$", "g"),
            de = new RegExp("^" + ie + "*," + ie + "*"), pe = new RegExp("^" + ie + "*([>+~]|" + ie + ")" + ie + "*"),
            ue = new RegExp("=" + ie + "*([^\\]'\"]*?)" + ie + "*\\]", "g"), ce = new RegExp(oe),
            he = new RegExp("^" + re + "$"), fe = {
                ID: new RegExp("^#(" + ae + ")"),
                CLASS: new RegExp("^\\.(" + ae + ")"),
            ...
            ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, we = /[+~]/, be = /'|\\/g,
            xe = new RegExp("\\\\([\\da-f]{1,6}" + ie + "?|(" + ie + ")|.)", "ig"), Te = function (e, t, n) {
                var i = "0x" + t - 65536;
                return i !== i || n ? t : 0 > i ? String.fromCharCode(i + 65536) : String.fromCharCode(i >> 10 | 55296, 1023 & i | 56320)
            };
        try {
            Z.apply(Q = ee.call(j.childNodes), j.childNodes), Q[j.childNodes.length].nodeType
        } catch (Ce) {
            Z = {
        ...
        C = t.support = {}, k = t.isXML = function (e) {
            ...
            return n !== P && 9 === n.nodeType && n.documentElement ? (P = n, A = n.documentElement, $ = !k(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function () {
                L()
                ...
                return A.appendChild(e).id = B, !n.getElementsByName || !n.getElementsByName(B).length
            ...
            }, H = [], I = [], (C.qsa = ve.test(n.querySelectorAll)) && (a(function (e) {
                ...
                C.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), H.push("!=", oe)
            }), I = I.length && new RegExp(I.join("|")), H = H.length && new RegExp(H.join("|")), t = ve.test(A.compareDocumentPosition), _ = t || ve.test(A.contains) ? function (e, t) {
                ...
                return i ? i : (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & i || !C.sortDetached && t.compareDocumentPosition(e) === i ? e === n || e.ownerDocument === j && _(j, e) ? -1 : t === n || t.ownerDocument === j && _(j, t) ? 1 : D ? te.call(D, e) - te.call(D, t) : 0 : 4 & i ? -1 : 1)
            } : function (e, t) {
                if (e === t) return N = !0, 0;
                var i, a = 0, r = e.parentNode, o = t.parentNode, l = [e], d = [t];
                if (!r || !o) return e === n ? -1 : t === n ? 1 : r ? -1 : o ? 1 : D ? te.call(D, e) - te.call(D, t) : 0;
                if (r === o) return s(e, t);
            ...
            if ((e.ownerDocument || e) !== P && L(e), n = n.replace(ue, "='$1']"), !(!C.matchesSelector || !$ || H && H.test(n) || I && I.test(n))) try {
                var i = O.call(e, n);
            ...
            return (e.ownerDocument || e) !== P && L(e), _(e, t)
        }, t.attr = function (e, t) {
            ...
            var t, n = [], i = 0, a = 0;
            if (N = !C.detectDuplicates, D = !C.sortStable && e.slice(0), e.sort(Y), N) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === a ? function (e) {
                        ...
                        var d, p, u, c, h, f, m = r !== s ? "nextSibling" : "previousSibling", g = t.parentNode,
                            v = o && t.nodeName.toLowerCase(), y = !l && !o;
                        if (g) {
                            if (r) {
                                for (; m;) {
                                    for (u = t; u = u[m];) if (o ? u.nodeName.toLowerCase() === v : 1 === u.nodeType) return !1;
                                    f = m = "only" === e && !f && "nextSibling"
                                }
                                return !0
                            }
                            if (f = [s ? g.firstChild : g.lastChild], s && y) {
                                for (p = g[B] || (g[B] = {}), d = p[e] || [], h = d[0] === X && d[1], c = d[0] === X && d[2], u = h && g.childNodes[h]; u = ++h && u && u[m] || (c = h = 0) || f.pop();) if (1 === u.nodeType && ++c && u === t) {
                                    p[e] = [X, h, c];
                                    break
                                }
                            } else if (y && (d = (t[B] || (t[B] = {}))[e]) && d[0] === X) c = d[1]; else for (; (u = ++h && u && u[m] || (c = h = 0) || f.pop()) && ((o ? u.nodeName.toLowerCase() !== v : 1 !== u.nodeType) || !++c || (y && ((u[B] || (u[B] = {}))[e] = [X, c]), u !== t));) ;
                            return c -= a, c === i || c % i === 0 && c / i >= 0
                        }
                    }
                }, PSEUDO: function (e, n) {
                    var a, r = S.pseudos[e] || S.setFilters[e.toLowerCase()] || t.error("unsupported pseudo: " + e);
                    return r[B] ? r(n) : r.length > 1 ? (a = [e, e, "", n], S.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, t) {
        ...
        for (T in{radio: !0, checkbox: !0, file: !0, password: !0, image: !0}) S.pseudos[T] = o(T);
        for (T in{submit: !0, reset: !0}) S.pseudos[T] = l(T);
        return u.prototype = S.filters = S.pseudos, S.setFilters = new u, M = t.compile = function (e, t) {
            var n, i = [], a = [], r = q[e + " "];
            if (!r) {
                for (t || (t = c(e)), n = t.length; n--;) r = y(t[n]), r[B] ? i.push(r) : a.push(r);
                r = q(e, w(a, i))
            }
            return r
        }, C.sortStable = B.split("").sort(Y).join("") === B, C.detectDuplicates = !!N, L(),
    ...
    re.find = pe, re.expr = pe.selectors, re.expr[":"] = re.expr.pseudos, re.unique = pe.uniqueSort, re.text = pe.getText, re.isXMLDoc = pe.isXML, re.contains = pe.contains;
    var ue = re.expr.match.needsContext, ce = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, he = /^.[^:#\[\.,]*$/;
    ...
    var fe, me = e.document, ge = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ve = re.fn.init = function (e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (n[1]) {
                if (t = t instanceof re ? t[0] : t, re.merge(this, re.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : me, !0)), ce.test(n[1]) && re.isPlainObject(t)) for (n in t) re.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                return this
            }
    ...
    re.extend({
        ...
        has: function (e) {
            ...
            for (var n, i = 0, a = this.length, r = [], s = ue.test(e) || "string" != typeof e ? re(e, t || this.context) : 0; a > i; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && re.find.matchesSelector(n, e))) {
                r.push(n);
                break
            }
        ...
        re.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (a = re.filter(i, a)), this.length > 1 && (we[e] || (a = re.unique(a)), ye.test(e) && (a = a.reverse())), this.pushStack(a)
        }
    });
    var be = /\S+/g, xe = {};
    re.Callbacks = function (e) {
        ...
        var t, n, i, a, s, o, l = [], d = !e.once && [], p = function (r) {
            for (n = e.memory && r, i = !0, s = o || 0, o = 0, a = l.length, t = !0; l && a > s; s++) if (l[s].apply(r[0], r[1]) === !1 && e.stopOnFalse) {
                n = !1;
                break
            }
            t = !1, l && (d ? d.length && p(d.shift()) : n ? l = [] : u.disable())
        }, u = {
            add: function () {
                if (l) {
                    var i = l.length;
                    ...
                    }(arguments), t ? a = l.length : n && (o = i, p(n))
                }
                return this
            }, remove: function () {
                return l && re.each(arguments, function (e, n) {
                    for (var i; (i = re.inArray(n, l, i)) > -1;) l.splice(i, 1), t && (a >= i && a--, s >= i && s--)
                }), this
            }, has: function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, i, a = 0, r = U.call(arguments), s = r.length,
                o = 1 !== s || e && re.isFunction(e.promise) ? s : 0, l = 1 === o ? e : re.Deferred(),
                d = function (e, n, i) {
                    return function (a) {
                        n[e] = this, i[e] = arguments.length > 1 ? U.call(arguments) : a, i === t ? l.notifyWith(n, i) : --o || l.resolveWith(n, i)
                    }
                };
            if (s > 1) for (t = new Array(s), n = new Array(s), i = new Array(s); s > a; a++) r[a] && re.isFunction(r[a].promise) ? r[a].promise().done(d(a, i, r)).fail(l.reject).progress(d(a, n, t)) : --o;
    ...
    re.fn.ready = function (e) {
        ...
        if (!Te) if (Te = re.Deferred(), "complete" === me.readyState) setTimeout(re.ready); else if (me.addEventListener) me.addEventListener("DOMContentLoaded", o, !1), e.addEventListener("load", o, !1); else {
            me.attachEvent("onreadystatechange", o), e.attachEvent("onload", o);
            var n = !1;
            try {
    ...
    re.extend({
        ...
        hasData: function (e) {
            return e = e.nodeType ? re.cache[e[re.expando]] : e[re.expando], !!e && !d(e)
        },
        data: function (e, t, n) {
            return p(e, t, n)
        },
        ...
        queue: function (e, t, n) {
            ...
            t = t || "fx";
            var n = re.queue(e, t), i = n.length, a = n.shift(), r = re._queueHooks(e, t), s = function () {
                re.dequeue(e, t)
            };
        ...
        queue: function (e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;) n = re._data(r[s], e + "queueHooks"), n && n.empty && (i++, n.empty.add(o));
            return o(), a.promise(t)
        }
    });
    var Me = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ze = ["Top", "Right", "Bottom", "Left"],
        De = function (e, t) {
            ...
            if ("object" === re.type(n)) {
                a = !0;
                for (o in n) re.access(e, t, o, n[o], !0, r, s)
            } else if (void 0 !== i && (a = !0, re.isFunction(i) || (s = !0), d && (s ? (t.call(e, i), t = null) : (d = t, t = function (e, t, n) {
    ...
    var Pe = /^(?:input|select|textarea)$/i, Ae = /^key/, $e = /^(?:mouse|contextmenu)|click/,
        Ie = /^(?:focusinfocus|focusoutblur)$/, He = /^([^.]*)(?:\.(.+)|)$/;
    re.event = {
        global: {},
        add: function (e, t, n, i, a) {
            var r, s, o, l, d, p, u, c, h, f, m, g = re._data(e);
            if (g) {
                for (n.handler && (l = n, n = l.handler, a = l.selector), n.guid || (n.guid = re.guid++), (s = g.events) || (s = g.events = {}), (p = g.handle) || (p = g.handle = function (e) {
                    return typeof re === Se || e && re.event.triggered === e.type ? void 0 : re.event.dispatch.apply(p.elem, arguments)
                }, p.elem = e), t = (t || "").match(be) || [""], o = t.length; o--;) r = He.exec(t[o]) || [], h = m = r[1], f = (r[2] || "").split(".").sort(), h && (d = re.event.special[h] || {}, h = (a ? d.delegateType : d.bindType) || h, d = re.event.special[h] || {}, u = re.extend({
                    type: h,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, l), (c = s[h]) || (c = s[h] = [], c.delegateCount = 0, d.setup && d.setup.call(e, i, f, p) !== !1 || (e.addEventListener ? e.addEventListener(h, p, !1) : e.attachEvent && e.attachEvent("on" + h, p))), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), a ? c.splice(c.delegateCount++, 0, u) : c.push(u), re.event.global[h] = !0);
                e = null
            }
        },
        remove: function (e, t, n, i, a) {
            ...
            if (g && (p = g.events)) {
                for (t = (t || "").match(be) || [""], d = t.length; d--;) if (o = He.exec(t[d]) || [], h = m = o[1], f = (o[2] || "").split(".").sort(), h) {
                    for (u = re.event.special[h] || {}, h = (i ? u.delegateType : u.bindType) || h, c = p[h] || [], o = o[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = c.length; r--;) s = c[r], !a && m !== s.origType || n && n.guid !== s.guid || o && !o.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (c.splice(r, 1), s.selector && c.delegateCount--, u.remove && u.remove.call(e, s));
                    l && !c.length && (u.teardown && u.teardown.call(e, f, g.handle) !== !1 || re.removeEvent(e, h, g.handle), delete p[h])
                } else for (h in p) re.event.remove(e, h + t[d], n, i, !0);
                re.isEmptyObject(p) && (delete g.handle, re._removeData(e, "events"))
            }
        },
        trigger: function (t, n, i, a) {
            var r, s, o, l, d, p, u, c = [i || me], h = te.call(t, "type") ? t.type : t,
                f = te.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = p = i = i || me, 3 !== i.nodeType && 8 !== i.nodeType && !Ie.test(h + re.event.triggered) && (h.indexOf(".") >= 0 && (f = h.split("."), h = f.shift(), f.sort()), s = h.indexOf(":") < 0 && "on" + h, t = t[re.expando] ? t : new re.Event(h, "object" == typeof t && t), t.isTrigger = a ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : re.makeArray(n, [t]), d = re.event.special[h] || {}, a || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                if (!a && !d.noBubble && !re.isWindow(i)) {
                    for (l = d.delegateType || h, Ie.test(l + h) || (o = o.parentNode); o; o = o.parentNode) c.push(o), p = o;
                    p === (i.ownerDocument || me) && c.push(p.defaultView || p.parentWindow || e)
                }
                for (u = 0; (o = c[u++]) && !t.isPropagationStopped();) t.type = u > 1 ? l : d.bindType || h, r = (re._data(o, "events") || {})[t.type] && re._data(o, "handle"), r && r.apply(o, n), r = s && o[s], r && r.apply && re.acceptData(o) && (t.result = r.apply(o, n), t.result === !1 && t.preventDefault());
                if (t.type = h, !a && !t.isDefaultPrevented() && (!d._default || d._default.apply(c.pop(), n) === !1) && re.acceptData(i) && s && i[h] && !re.isWindow(i)) {
                    p = i[s], p && (i[s] = null), re.event.triggered = h;
                    try {
                        i[h]()
                    } catch (m) {
                    }
                    re.event.triggered = void 0, p && (i[s] = p)
                }
                return t.result
            }
        },
        ...
        handlers: function (e, t) {
            ...
            if (o && l.nodeType && (!e.button || "click" !== e.type)) for (; l != this; l = l.parentNode || this) if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
                for (a = [], r = 0; o > r; r++) i = t[r], n = i.selector + " ", void 0 === a[n] && (a[n] = i.needsContext ? re(n, this).index(l) >= 0 : re.find(n, this, null, [l]).length), a[n] && a.push(i);
        ...
        fix: function (e) {
            ...
            for (s || (this.fixHooks[a] = s = $e.test(a) ? this.mouseHooks : Ae.test(a) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new re.Event(r), t = i.length; t--;) n = i[t], e[n] = r[n];
        ...
        simulate: function (e, t, n, i) {
            var a = re.extend(new re.Event, n, {type: e, isSimulated: !0, originalEvent: {}});
        ...
        return this instanceof re.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && (e.returnValue === !1 || e.getPreventDefault && e.getPreventDefault()) ? c : h) : this.type = e, t && re.extend(this, t), this.timeStamp = e && e.timeStamp || re.now(), void (this[re.expando] = !0)) : new re.Event(e, t)
    }, re.Event.prototype = {
        ...
        re.event.special[t] = {
            setup: function () {
                var i = this.ownerDocument || this, a = re._data(i, t);
                a || i.addEventListener(e, n, !0), re._data(i, t, (a || 0) + 1)
            }, teardown: function () {
                var i = this.ownerDocument || this, a = re._data(i, t) - 1;
    ...
    var Oe = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        _e = / jQuery\d+="(?:null|\d+)"/g, Be = new RegExp("<(?:" + Oe + ")[\\s/>]", "i"), je = /^\s+/,
        Xe = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, We = /<([\w:]+)/,
        Fe = /<tbody/i, Re = /<|&#?\w+;/, qe = /<(?:script|style|link)/i, Ye = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Ge = /^$|\/(?:java|ecma)script/i, Ve = /^true\/(.*)/, Ue = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Qe = {
        ...
        }, Ke = m(me), Je = Ke.appendChild(me.createElement("div"));
    Qe.optgroup = Qe.option, Qe.tbody = Qe.tfoot = Qe.colgroup = Qe.caption = Qe.thead, Qe.th = Qe.td, re.extend({
        clone: function (e, t, n) {
            ...
            if (ie.html5Clone || re.isXMLDoc(e) || !Be.test("<" + e.nodeName + ">") ? r = e.cloneNode(!0) : (Je.innerHTML = e.outerHTML, Je.removeChild(r = Je.firstChild)), !(ie.noCloneEvent && ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || re.isXMLDoc(e))) for (i = g(r), o = g(e), s = 0; null != (a = o[s]); ++s) i[s] && C(a, i[s]);
            if (t) if (n) for (o = o || g(e), i = i || g(r), s = 0; null != (a = o[s]); s++) T(a, i[s]); else T(e, r);
            return i = g(r, "script"), i.length > 0 && x(i, !l && g(e, "script")), i = o = a = null, r
        }, buildFragment: function (e, t, n, i) {
            for (var a, r, s, o, l, d, p, u = e.length, c = m(t), h = [], f = 0; u > f; f++) if (r = e[f], r || 0 === r) if ("object" === re.type(r)) re.merge(h, r.nodeType ? [r] : r); else if (Re.test(r)) {
                for (o = o || c.appendChild(t.createElement("div")), l = (We.exec(r) || ["", ""])[1].toLowerCase(), p = Qe[l] || Qe._default, o.innerHTML = p[1] + r.replace(Xe, "<$1></$2>") + p[2], a = p[0]; a--;) o = o.lastChild;
                if (!ie.leadingWhitespace && je.test(r) && h.push(t.createTextNode(je.exec(r)[0])), !ie.tbody) for (r = "table" !== l || Fe.test(r) ? "<table>" !== p[1] || Fe.test(r) ? 0 : o : o.firstChild, a = r && r.childNodes.length; a--;) re.nodeName(d = r.childNodes[a], "tbody") && !d.childNodes.length && r.removeChild(d);
                for (re.merge(h, o.childNodes), o.textContent = ""; o.firstChild;) o.removeChild(o.firstChild);
                o = c.lastChild
            } else h.push(t.createTextNode(r));
            for (o && c.removeChild(o), ie.appendChecked || re.grep(g(h, "input"), v), f = 0; r = h[f++];) if ((!i || -1 === re.inArray(r, i)) && (s = re.contains(r.ownerDocument, r), o = g(c.appendChild(r), "script"), s && x(o), n)) for (a = 0; r = o[a++];) Ge.test(r.type || "") && n.push(r);
            return o = null, c
        }, cleanData: function (e, t) {
            for (var n, i, a, r, s = 0, o = re.expando, l = re.cache, d = ie.deleteExpando, p = re.event.special; null != (n = e[s]); s++) if ((t || re.acceptData(n)) && (a = n[o], r = a && l[a])) {
                if (r.events) for (i in r.events) p[i] ? re.event.remove(n, i) : re.removeEvent(n, i, r.handle);
                l[a] && (delete l[a], d ? delete n[o] : typeof n.removeAttribute !== Se ? n.removeAttribute(o) : n[o] = null, V.push(a))
            }
        }
    }), re.fn.extend({
        text: function (e) {
            ...
            for (var n, i = e ? re.filter(e, this) : this, a = 0; null != (n = i[a]); a++) t || 1 !== n.nodeType || re.cleanData(g(n)), n.parentNode && (t && re.contains(n.ownerDocument, n) && x(g(n, "script")), n.parentNode.removeChild(n));
            return this
        }, empty: function () {
            ...
            if (h || d > 1 && "string" == typeof c && !ie.checkClone && Ye.test(c)) return this.each(function (n) {
                var i = p.eq(n);
                h && (e[0] = c.call(this, n, i.html())), i.domManip(e, t)
            });
            if (d && (o = re.buildFragment(e, this[0].ownerDocument, !1, this), n = o.firstChild, 1 === o.childNodes.length && (o = n), n)) {
                for (r = re.map(g(o, "script"), w), a = r.length; d > l; l++) i = o, l !== u && (i = re.clone(i, !0, !0), a && re.merge(r, g(i, "script"))), t.call(this[l], i, l);
                if (a) for (s = r[r.length - 1].ownerDocument, re.map(r, b), l = 0; a > l; l++) i = r[l], Ge.test(i.type || "") && !re._data(i, "globalEval") && re.contains(s, i) && (i.src ? re._evalUrl && re._evalUrl(i.src) : re.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Ue, "")));
                o = n = null
            }
            return this
        }
        ...
        re.fn[e] = function (e) {
            for (var n, i = 0, a = [], r = re(e), s = r.length - 1; s >= i; i++) n = i === s ? this : this.clone(!0), re(r[i])[t](n), K.apply(a, n.get());
    ...
    !function () {
        ...
        n.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", e = n.getElementsByTagName("a")[0], e.style.cssText = "float:left;opacity:.5", ie.opacity = /^0.5/.test(e.style.opacity), ie.cssFloat = !!e.style.cssFloat, n.style.backgroundClip = "content-box", n.cloneNode(!0).style.backgroundClip = "", ie.clearCloneStyle = "content-box" === n.style.backgroundClip, e = n = null, ie.shrinkWrapBlocks = function () {
            ...
            if (null == t) {
                ...
                r = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px", n = me.createElement("div"), a = me.createElement("div"), e.appendChild(n).appendChild(a), t = !1, typeof a.style.zoom !== Se && (a.style.cssText = i + ";width:1px;padding:1px;zoom:1", a.innerHTML = "<div></div>", a.firstChild.style.width = "5px", t = 3 !== a.offsetWidth), e.removeChild(n), e = n = a = null
            }
            return t
        }
    }();
    ...
    e.getComputedStyle ? (tt = function (e) {
        ...
        return n = n || tt(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, n && ("" !== s || re.contains(e.ownerDocument, e) || (s = re.style(e, t)), at.test(s) && it.test(t) && (i = o.width, a = o.minWidth, r = o.maxWidth, o.minWidth = o.maxWidth = o.width = s, s = n.width, o.width = i, o.minWidth = a, o.maxWidth = r)), void 0 === s ? s : s + ""
    }) : me.documentElement.currentStyle && (tt = function (e) {
        return e.currentStyle
    }, nt = function (e, t, n) {
        var i, a, r, s, o = e.style;
        return n = n || tt(e), s = n ? n[t] : void 0, null == s && o && o[t] && (s = o[t]), at.test(s) && !rt.test(t) && (i = o.left, a = e.runtimeStyle, r = a && a.left, r && (a.left = e.currentStyle.left), o.left = "fontSize" === t ? "1em" : s, s = o.pixelLeft + "px", o.left = i, r && (a.left = r)), void 0 === s ? s : s + "" || "auto"
    }), !function () {
        function t() {
            var t, n, i = me.getElementsByTagName("body")[0];
            i && (t = me.createElement("div"), n = me.createElement("div"), t.style.cssText = d, i.appendChild(t).appendChild(n), n.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;display:block;padding:1px;border:1px;width:4px;margin-top:1%;top:1%", re.swap(i, null != i.style.zoom ? {zoom: 1} : {}, function () {
                a = 4 === n.offsetWidth
            }), r = !0, s = !1, o = !0, e.getComputedStyle && (s = "1%" !== (e.getComputedStyle(n, null) || {}).top, r = "4px" === (e.getComputedStyle(n, null) || {width: "4px"}).width), i.removeChild(t), n = i = null)
        }

        var n, i, a, r, s, o, l = me.createElement("div"),
            d = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px",
            p = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0";
        l.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", n = l.getElementsByTagName("a")[0], n.style.cssText = "float:left;opacity:.5", ie.opacity = /^0.5/.test(n.style.opacity), ie.cssFloat = !!n.style.cssFloat,
            l.style.backgroundClip = "content-box", l.cloneNode(!0).style.backgroundClip = "", ie.clearCloneStyle = "content-box" === l.style.backgroundClip, n = l = null, re.extend(ie, {
            reliableHiddenOffsets: function () {
                if (null != i) return i;
                var e, t, n, a = me.createElement("div"), r = me.getElementsByTagName("body")[0];
                return r ? (a.setAttribute("className", "t"), a.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", e = me.createElement("div"), e.style.cssText = d, r.appendChild(e).appendChild(a), a.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", t = a.getElementsByTagName("td"), t[0].style.cssText = "padding:0;margin:0;border:0;display:none", n = 0 === t[0].offsetHeight, t[0].style.display = "", t[1].style.display = "none", i = n && 0 === t[0].offsetHeight, r.removeChild(e), a = r = null, i) : void 0
            }, boxSizing: function () {
                return null == a && t(), a
                ...
                if (null == o && e.getComputedStyle) {
                    ...
                    n = me.createElement("div"), i = me.createElement("div"), n.style.cssText = d, t.appendChild(n).appendChild(i), a = i.appendChild(me.createElement("div")), a.style.cssText = i.style.cssText = p, a.style.marginRight = a.style.width = "0", i.style.width = "1px", o = !parseFloat((e.getComputedStyle(a, null) || {}).marginRight), t.removeChild(n)
                }
                return o
            }
        })
    ...
    var st = /alpha\([^)]*\)/i, ot = /opacity\s*=\s*([^)]*)/, lt = /^(none|table(?!-c[ea]).+)/,
        dt = new RegExp("^(" + Me + ")(.*)$", "i"), pt = new RegExp("^([+-])=(" + Me + ")", "i"),
        ut = {position: "absolute", visibility: "hidden", display: "block"}, ct = {letterSpacing: 0, fontWeight: 400},
        ht = ["Webkit", "O", "Moz", "ms"];
    re.extend({
        cssHooks: {
            opacity: {
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (t = re.cssProps[o] || (re.cssProps[o] = M(l, o)), s = re.cssHooks[t] || re.cssHooks[o], void 0 === n) return s && "get" in s && void 0 !== (a = s.get(e, !1, i)) ? a : l[t];
                if (r = typeof n, "string" === r && (a = pt.exec(n)) && (n = (a[1] + 1) * a[2] + parseFloat(re.css(e, t)), r = "number"), null != n && n === n && ("number" !== r || re.cssNumber[o] || (n += "px"), ie.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(s && "set" in s && void 0 === (n = s.set(e, n, i))))) try {
                    l[t] = "", l[t] = n
                } catch (d) {
                }
            }
        ...
        css: function (e, t, n, i) {
            ...
            return t = re.cssProps[o] || (re.cssProps[o] = M(e.style, o)), s = re.cssHooks[t] || re.cssHooks[o], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = nt(e, t, i)), "normal" === r && t in ct && (r = ct[t]), "" === n || n ? (a = parseFloat(r), n === !0 || re.isNumeric(a) ? a || 0 : r) : r
        }
        ...
        get: function (e, t) {
            ...
            var n = e.style, i = e.currentStyle, a = re.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
                r = i && i.filter || n.filter || "";
            n.zoom = 1, (t >= 1 || "" === t) && "" === re.trim(r.replace(st, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || i && !i.filter) || (n.filter = st.test(r) ? r.replace(st, a) : r + " " + a)
        }
        ...
        re.cssHooks[e + t] = {
            expand: function (n) {
                for (var i = 0, a = {}, r = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) a[e + ze[i] + t] = r[i] || r[i - 2] || r[0];
                return a
            }
        ...
        css: function (e, t) {
            return Ne(this, function (e, t, n) {
                var i, a, r = {}, s = 0;
                if (re.isArray(t)) {
                    for (i = tt(e), a = t.length; a > s; s++) r[t[s]] = re.css(e, t[s], !1, i);
                    return r
                }
        ...
        constructor: P, init: function (e, t, n, i, a, r) {
            ...
            return this.pos = t = this.options.duration ? re.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : P.propHooks._default.set(this), this
        }
    ...
    var ft, mt, gt = /^(?:toggle|show|hide)$/, vt = new RegExp("^(?:([+-])=|)(" + Me + ")([a-z%]*)$", "i"),
        yt = /queueHooks$/, wt = [H], bt = {
            "*": [function (e, t) {
                var n = this.createTween(e, t), i = n.cur(), a = vt.exec(t), r = a && a[3] || (re.cssNumber[e] ? "" : "px"),
                    s = (re.cssNumber[e] || "px" !== r && +i) && vt.exec(re.css(n.elem, e)), o = 1, l = 20;
                if (s && s[3] !== r) {
                    r = r || s[3], a = a || [], s = +i || 1;
                    do o = o || ".5", s /= o, re.style(n.elem, e, s + r); while (o !== (o = n.cur() / i) && 1 !== o && --l)
                }
    ...
    re.Animation = re.extend(_, {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            var a = re.isEmptyObject(e), r = re.speed(t, n, i), s = function () {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                var t = !0, a = null != e && e + "queueHooks", r = re.timers, s = re._data(this);
                if (a) s[a] && s[a].stop && i(s[a]); else for (a in s) s[a] && s[a].stop && yt.test(a) && i(s[a]);
                for (a = r.length; a--;) r[a].elem !== this || null != e && r[a].queue !== e || (r[a].anim.stop(n), t = !1, r.splice(a, 1));
                (t || !n) && re.dequeue(this, e)
            })
        }, finish: function (e) {
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = re._data(this), i = n[e + "queue"], a = n[e + "queueHooks"], r = re.timers,
                    s = i ? i.length : 0;
    ...
    re.fn.extend({
        val: function (e) {
            ...
            })) : a ? (t = re.valHooks[a.type] || re.valHooks[a.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(a, "value")) ? n : (n = a.value, "string" == typeof n ? n.replace(xt, "") : null == n ? "" : n)) : void 0
        }
    }), re.extend({
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, i = e.options, a = e.selectedIndex, r = "select-one" === e.type || 0 > a, s = r ? null : [], o = r ? a + 1 : i.length, l = 0 > a ? o : r ? a : 0; o > l; l++) if (n = i[l], !(!n.selected && l !== a || (ie.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && re.nodeName(n.parentNode, "optgroup"))) {
                        if (t = re(n).val(), r) return t;
                        s.push(t)
                    }
                    return s
                }, set: function (e, t) {
                    for (var n, i, a = e.options, r = re.makeArray(t), s = a.length; s--;) if (i = a[s], re.inArray(re.valHooks.option.get(i), r) >= 0) try {
                        i.selected = n = !0
                    } catch (o) {
                        i.scrollHeight
                    } else i.selected = !1;
    ...
    re.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            return e && 3 !== r && 8 !== r && 2 !== r ? typeof e.getAttribute === Se ? re.prop(e, t, n) : (1 === r && re.isXMLDoc(e) || (t = t.toLowerCase(), i = re.attrHooks[t] || (re.expr.match.bool.test(t) ? Ct : Tt)), void 0 === n ? i && "get" in i && null !== (a = i.get(e, t)) ? a : (a = re.find.attr(e, t), null == a ? void 0 : a) : null !== n ? i && "set" in i && void 0 !== (a = i.set(e, n, t)) ? a : (e.setAttribute(t, n + ""), n) : void re.removeAttr(e, t)) : void 0
        }, removeAttr: function (e, t) {
            var n, i, a = 0, r = t && t.match(be);
            if (r && 1 === e.nodeType) for (; n = r[a++];) i = re.propFix[n] || n, re.expr.match.bool.test(n) ? Mt && kt || !Et.test(n) ? e[i] = !1 : e[re.camelCase("default-" + n)] = e[i] = !1 : re.attr(e, n, ""), e.removeAttribute(kt ? n : i)
        }, attrHooks: {
            type: {
                set: function (e, t) {
        ...
        set: function (e, t, n) {
            return t === !1 ? re.removeAttr(e, n) : Mt && kt || !Et.test(n) ? e.setAttribute(!kt && re.propFix[n] || n, n) : e[re.camelCase("default-" + n)] = e[n] = !0, n
        }
    ...
    var zt = /^(?:input|select|textarea|button|object)$/i, Dt = /^(?:a|area)$/i;
    re.fn.extend({
        prop: function (e, t) {
        ...
        propFix: {"for": "htmlFor", "class": "className"}, prop: function (e, t, n) {
            ...
            return e && 3 !== s && 8 !== s && 2 !== s ? (r = 1 !== s || !re.isXMLDoc(e), r && (t = re.propFix[t] || t, a = re.propHooks[t]), void 0 !== n ? a && "set" in a && void 0 !== (i = a.set(e, n, t)) ? i : e[t] = n : a && "get" in a && null !== (i = a.get(e, t)) ? i : e[t]) : void 0
        }, propHooks: {
            tabIndex: {
                get: function (e) {
    ...
    re.fn.extend({
        addClass: function (e) {
            ...
            if (d) for (t = (e || "").match(be) || []; l > o; o++) if (n = this[o], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Nt, " ") : " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(re.isFunction(e) ? function (n) {
                ...
                if ("string" === n) for (var t, i = 0, a = re(this), r = e.match(be) || []; t = r[i++];) a.hasClass(t) ? a.removeClass(t) : a.addClass(t); else (n === Se || "boolean" === n) && (this.className && re._data(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : re._data(this, "__className__") || "")
            })
        }, hasClass: function (e) {
    ...
    var $t, It, Ht = /#.*$/, Ot = /([?&])_=[^&]*/, _t = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Bt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, jt = /^(?:GET|HEAD)$/, Xt = /^\/\//,
        Wt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Ft = {}, Rt = {}, qt = "*/".concat("*");
    try {
        It = location.href
    } catch (Yt) {
        It = me.createElement("a"), It.href = "", It = It.href
    }
    $t = Wt.exec(It.toLowerCase()) || [], re.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (e, t) {
            function n(e, t, n, i) {
                var a, p, v, y, b, T = t;
                2 !== w && (w = 2, o && clearTimeout(o), d = void 0, s = i || "", x.readyState = e > 0 ? 4 : 0, a = e >= 200 && 300 > e || 304 === e, n && (y = W(u, x, n)), y = F(u, y, x, a), a ? (u.ifModified && (b = x.getResponseHeader("Last-Modified"), b && (re.lastModified[r] = b), b = x.getResponseHeader("etag"), b && (re.etag[r] = b)), 204 === e || "HEAD" === u.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = y.state, p = y.data, v = y.error, a = !v)) : (v = T, (e || !T) && (T = "error", 0 > e && (e = 0))), x.status = e, x.statusText = (t || T) + "", a ? f.resolveWith(c, [p, T, x]) : f.rejectWith(c, [x, T, v]), x.statusCode(g), g = void 0, l && h.trigger(a ? "ajaxSuccess" : "ajaxError", [x, u, a ? p : v]), m.fireWith(c, [x, T]), l && (h.trigger("ajaxComplete", [x, u]), --re.active || re.event.trigger("ajaxStop")))
            }

            "object" == typeof e && (t = e, e = void 0), t = t || {};
            var i, a, r, s, o, l, d, p, u = re.ajaxSetup({}, t), c = u.context || u,
                h = u.context && (c.nodeType || c.jquery) ? re(c) : re.event, f = re.Deferred(),
                m = re.Callbacks("once memory"), g = u.statusCode || {}, v = {}, y = {}, w = 0, b = "canceled", x = {
                    readyState: 0, getResponseHeader: function (e) {
                        var t;
                        if (2 === w) {
                            if (!p) for (p = {}; t = _t.exec(s);) p[t[1].toLowerCase()] = t[2];
                            t = p[e.toLowerCase()]
                        }
            ...
            if (f.promise(x).complete = m.add, x.success = x.done, x.error = x.fail, u.url = ((e || u.url || It) + "").replace(Ht, "").replace(Xt, $t[1] + "//"), u.type = t.method || t.type || u.method || u.type, u.dataTypes = re.trim(u.dataType || "*").toLowerCase().match(be) || [""], null == u.crossDomain && (i = Wt.exec(u.url.toLowerCase()), u.crossDomain = !(!i || i[1] === $t[1] && i[2] === $t[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === ($t[3] || ("http:" === $t[1] ? "80" : "443")))), u.data && u.processData && "string" != typeof u.data && (u.data = re.param(u.data, u.traditional)), j(Ft, u, t, x), 2 === w) return x;
            l = u.global, l && 0 === re.active++ && re.event.trigger("ajaxStart"), u.type = u.type.toUpperCase(), u.hasContent = !jt.test(u.type), r = u.url, u.hasContent || (u.data && (r = u.url += (Pt.test(r) ? "&" : "?") + u.data, delete u.data), u.cache === !1 && (u.url = Ot.test(r) ? r.replace(Ot, "$1_=" + Lt++) : r + (Pt.test(r) ? "&" : "?") + "_=" + Lt++)), u.ifModified && (re.lastModified[r] && x.setRequestHeader("If-Modified-Since", re.lastModified[r]), re.etag[r] && x.setRequestHeader("If-None-Match", re.etag[r])), (u.data && u.hasContent && u.contentType !== !1 || t.contentType) && x.setRequestHeader("Content-Type", u.contentType), x.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + ("*" !== u.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : u.accepts["*"]);
            for (a in u.headers) x.setRequestHeader(a, u.headers[a]);
            if (u.beforeSend && (u.beforeSend.call(c, x, u) === !1 || 2 === w)) return x.abort();
            b = "abort";
            for (a in{success: 1, error: 1, complete: 1}) x[a](u[a]);
            if (d = j(Rt, u, t, x)) {
                x.readyState = 1, l && h.trigger("ajaxSend", [x, u]), u.async && u.timeout > 0 && (o = setTimeout(function () {
                    x.abort("timeout")
                }, u.timeout));
                try {
                    w = 1, d.send(v, n)
    ...
    var Jt = 0, Zt = {}, en = re.ajaxSettings.xhr();
            ...
            return {
                send: function (n, i) {
                    ...
                    r.send(e.hasContent && e.data || null), t = function (n, a) {
                        var o, l, d;
                        if (t && (a || 4 === r.readyState)) if (delete Zt[s], t = void 0, r.onreadystatechange = re.noop, a) 4 !== r.readyState && r.abort(); else {
    ...
    re.ajaxSetup({
        ...
        var a, r, s,
            o = t.jsonp !== !1 && (nn.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && nn.test(t.data) && "data");
        return o || "jsonp" === t.dataTypes[0] ? (a = t.jsonpCallback = re.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, o ? t[o] = t[o].replace(nn, "$1" + a) : t.jsonp !== !1 && (t.url += (Pt.test(t.url) ? "&" : "?") + t.jsonp + "=" + a), t.converters["script json"] = function () {
            return s || re.error(a + " was not called"), s[0]
        }, t.dataTypes[0] = "json", r = e[a], e[a] = function () {
            s = arguments
        }, i.always(function () {
            e[a] = r, t[a] && (t.jsonpCallback = n.jsonpCallback, tn.push(a)), s && re.isFunction(r) && r(s[0]), s = r = void 0
        }), "script") : void 0
    ...
    re.fn.load = function (e, t, n) {
        ...
        return o >= 0 && (i = e.slice(o, e.length), e = e.slice(0, o)), re.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), s.length > 0 && re.ajax({
            url: e,
            type: r,
            dataType: "html",
            data: t
        }).done(function (e) {
            a = arguments, s.html(i ? re("<div>").append(re.parseHTML(e)).find(i) : e)
    ...
    re.offset = {
        setOffset: function (e, t, n) {
            ...
            "static" === p && (e.style.position = "relative"), o = u.offset(), r = re.css(e, "top"), l = re.css(e, "left"), d = ("absolute" === p || "fixed" === p) && re.inArray("auto", [r, l]) > -1, d ? (i = u.position(), s = i.top, a = i.left) : (s = parseFloat(r) || 0, a = parseFloat(l) || 0), re.isFunction(t) && (t = t.call(e, n, o)), null != t.top && (c.top = t.top - o.top + s), null != t.left && (c.left = t.left - o.left + a), "using" in t ? t.using.call(e, c) : u.css(c)
        }
    }, re.fn.extend({
        offset: function (e) {
            ...
            return r ? (t = r.documentElement, re.contains(t, a) ? (typeof a.getBoundingClientRect !== Se && (i = a.getBoundingClientRect()), n = G(r), {
        ...
        re.each({padding: "inner" + e, content: t, "": "outer" + e}, function (n, i) {
            re.fn[i] = function (i, a) {
                ...
                return Ne(this, function (t, n, i) {
                    var a;
                    return re.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (a = t.documentElement, Math.max(t.body["scroll" + e], a["scroll" + e], t.body["offset" + e], a["offset" + e], a["client" + e])) : void 0 === i ? re.css(t, n, s) : re.style(t, n, i, s)
                }, t, r ? i : void 0, r, null)
            }
        })
    }), re.fn.size = function () {
    ...
    var sn = e.jQuery, on = e.$;
    return re.noConflict = function (t) {
        return e.$ === re && (e.$ = on), t && e.jQuery === re && (e.jQuery = sn), re
    ...
    function i(i, s) {
        function o() {
            if (S) {
                v = t.createElement("canvas"), v.className = "pg-canvas", v.style.display = "block", i.insertBefore(v, i.firstChild), y = v.getContext("2d"), l();
                for (var n = Math.round(v.width * v.height / s.density), a = 0; n > a; a++) {
                    var r = new h;
                    r.setStackPos(a), E.push(r)
                }
                e.addEventListener("resize", function () {
                    p()
                }, !1), t.addEventListener("mousemove", function (e) {
                    k = e.pageX, M = e.pageY
                }, !1), D && !z && e.addEventListener("deviceorientation", function () {
                    L = Math.min(Math.max(-event.beta, -30), 30), N = Math.min(Math.max(-event.gamma, -30), 30)
                }, !0), d(), g("onInit")
            }
        }

        function l() {
            v.width = i.offsetWidth, v.height = i.offsetHeight, y.fillStyle = s.dotColor, y.strokeStyle = s.lineColor, y.lineWidth = s.lineWidth
        }

        function d() {
            if (S) {
                b = e.innerWidth, x = e.innerHeight, y.clearRect(0, 0, v.width, v.height);
                for (var t = 0; t < E.length; t++) E[t].updatePosition();
                for (var t = 0; t < E.length; t++) E[t].draw();
        ...
        function p() {
            l();
            for (var e = i.offsetWidth, t = i.offsetHeight, n = E.length - 1; n >= 0; n--) (E[n].position.x > e || E[n].position.y > t) && E.splice(n, 1);
            var a = Math.round(v.width * v.height / s.density);
            if (a > E.length) for (; a > E.length;) {
                var r = new h;
                E.push(r)
            } else a < E.length && E.splice(a);
            for (n = E.length - 1; n >= 0; n--) E[n].setStackPos(n)
        }
        ...
        function m() {
            console.log("destroy"), v.parentNode.removeChild(v), g("onDestroy"), r && r(i).removeData("plugin_" + a)
        }
        ...
        var v, y, w, b, x, T, C, S = !!t.createElement("canvas").getContext, E = [], k = 0, M = 0,
            z = !navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i),
            D = !!e.DeviceOrientationEvent, N = 0, L = 0, P = !1;
        return s = n({}, e[a].defaults, s), h.prototype.draw = function () {
            ...
            for (var e = E.length - 1; e > this.stackPos; e--) {
                var t = E[e], n = this.position.x - t.position.x, i = this.position.y - t.position.y,
                    a = Math.sqrt(n * n + i * i).toFixed(2);
                a < s.proximity && (y.moveTo(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY), s.curvedLines ? y.quadraticCurveTo(Math.max(t.position.x, t.position.x), Math.min(t.position.y, t.position.y), t.position.x + t.parallaxOffsetX, t.position.y + t.parallaxOffsetY) : y.lineTo(t.position.x + t.parallaxOffsetX, t.position.y + t.parallaxOffsetY))
            }
            ...
            if (s.parallax) {
                ...
                this.parallaxTargX = (T - b / 2) / (s.parallaxMultiplier * this.layer), this.parallaxOffsetX += (this.parallaxTargX - this.parallaxOffsetX) / 10, this.parallaxTargY = (C - x / 2) / (s.parallaxMultiplier * this.layer), this.parallaxOffsetY += (this.parallaxTargY - this.parallaxOffsetY) / 10
            }
            var n = i.offsetWidth, a = i.offsetHeight;
            switch (s.directionX) {
                case"left":
            ...
            this.stackPos = e
        }, o(), {option: f, destroy: m, start: c, pause: u}
    }

    var a = "particleground", r = e.jQuery;
    e[a] = function (e, t) {
        return new i(e, t)
    }, e[a].defaults = {
        minSpeedX: .1,
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function (t, n) {
        var i = (new Date).getTime(), a = Math.max(0, 16 - (i - e)), r = window.setTimeout(function () {
            t(i + a)
        }, a);
        return e = i + a, r
...
+function (e) {
    ...
    i.VERSION = "3.2.0", i.prototype.close = function (t) {
        ...
        var r = e(a);
        t && t.preventDefault(), r.length || (r = i.hasClass("alert") ? i : i.parent()), r.trigger(t = e.Event("close.bs.alert")), t.isDefaultPrevented() || (r.removeClass("in"), e.support.transition && r.hasClass("fade") ? r.one("bsTransitionEnd", n).emulateTransitionEnd(150) : n())
    };
    var a = e.fn.alert;
    ...
    n.VERSION = "3.2.0", n.DEFAULTS = {loadingText: "loading..."}, n.prototype.setState = function (t) {
        ...
        t += "Text", null == r.resetText && i.data("resetText", i[a]()), i[a](null == r[t] ? this.options[t] : r[t]), setTimeout(e.proxy(function () {
    ...
    function t(t) {
        return this.each(function () {
            var i = e(this), a = i.data("bs.carousel"),
    ...
    n.VERSION = "3.2.0", n.DEFAULTS = {interval: 5e3, pause: "hover", wrap: !0}, n.prototype.keydown = function (e) {
        ...
        var i = this.$element.find(".item.active"), a = n || i[t](), r = this.interval,
            s = "next" == t ? "left" : "right", o = "next" == t ? "first" : "last", l = this;
        if (!a.length) {
        ...
        if (this.$element.trigger(p), !p.isDefaultPrevented()) {
            ...
            }).emulateTransitionEnd(1e3 * i.css("transition-duration").slice(0, -1))) : (i.removeClass("active"), a.addClass("active"), this.sliding = !1, this.$element.trigger(c)), r && this.cycle(), this
        }
    };
    var i = e.fn.carousel;
    e.fn.carousel = t, e.fn.carousel.Constructor = n, e.fn.carousel.noConflict = function () {
        ...
        if (r.hasClass("carousel")) {
            var s = e.extend({}, r.data(), a.data()), o = a.attr("data-slide-to");
    ...
    function t(t) {
        return this.each(function () {
            var i = e(this), a = i.data("bs.collapse"),
                r = e.extend({}, n.DEFAULTS, i.data(), "object" == typeof t && t);
            !a && r.toggle && "show" == t && (t = !t), a || i.data("bs.collapse", a = new n(this, r)), "string" == typeof t && a[t]()
        })
    }
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(n), !n.isDefaultPrevented()) {
                ...
                if (i && i.length) {
                    ...
                    t.call(i, "hide"), a || i.data("bs.collapse", null)
                }
    ...
    e.fn.collapse = t, e.fn.collapse.Constructor = n, e.fn.collapse.noConflict = function () {
        ...
        var i, a = e(this),
            ...
            s = e(r), o = s.data("bs.collapse"), l = o ? "toggle" : a.data(), d = a.attr("data-parent"), p = d && e(d);
        o && o.transitioning || (p && p.find('[data-toggle="collapse"][data-parent="' + d + '"]').not(a).addClass("collapsed"), a[s.hasClass("in") ? "addClass" : "removeClass"]("collapsed")), t.call(s, l)
    })
}(jQuery), +function (e) {
    "use strict";
    ...
    function t(t) {
        t && 3 === t.which || (e(a).remove(), e(r).each(function () {
            var i = n(e(this)), a = {relatedTarget: this};
            i.hasClass("open") && (i.trigger(t = e.Event("hide.bs.dropdown", a)), t.isDefaultPrevented() || i.removeClass("open").trigger("hidden.bs.dropdown", a))
        }))
    }
    ...
    var a = ".dropdown-backdrop", r = '[data-toggle="dropdown"]', s = function (t) {
        e(t).on("click.bs.dropdown", this.toggle)
    };
    s.VERSION = "3.2.0", s.prototype.toggle = function (i) {
        var a = e(this);
        if (!a.is(".disabled, :disabled")) {
            var r = n(a), s = r.hasClass("open");
            if (t(), !s) {
        ...
        if (/(38|40|27)/.test(t.keyCode)) {
            ...
            if (t.preventDefault(), t.stopPropagation(), !i.is(".disabled, :disabled")) {
                ...
                if (!s || s && 27 == t.keyCode) return 27 == t.which && a.find(r).trigger("focus"), i.trigger("click");
                var o = " li:not(.divider):visible a", l = a.find('[role="menu"]' + o + ', [role="listbox"]' + o);
                if (l.length) {
                    var d = l.index(l.filter(":focus"));
                    38 == t.keyCode && d > 0 && d--, 40 == t.keyCode && d < l.length - 1 && d++, ~d || (d = 0), l.eq(d).trigger("focus")
                }
            }
        }
    };
    ...
    function t(t, i) {
        return this.each(function () {
            var a = e(this), r = a.data("bs.modal"), s = e.extend({}, n.DEFAULTS, a.data(), "object" == typeof t && t);
    ...
    e.fn.modal = t, e.fn.modal.Constructor = n, e.fn.modal.noConflict = function () {
        ...
        var i = e(this), a = i.attr("href"), r = e(i.attr("data-target") || a && a.replace(/.*(?=#[^\s]+$)/, "")),
            s = r.data("bs.modal") ? "toggle" : e.extend({remote: !/#/.test(a) && a}, r.data(), i.data());
    ...
    n.VERSION = "3.2.0", n.DEFAULTS = {
        ...
        for (var a = this.options.trigger.split(" "), r = a.length; r--;) {
            ...
            if ("click" == s) this.$element.on("click." + this.type, this.options.selector, e.proxy(this.toggle, this)); else if ("manual" != s) {
                var o = "hover" == s ? "mouseenter" : "focusin", l = "hover" == s ? "mouseleave" : "focusout";
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var i = this, a = this.tip(), r = this.getUID(this.type);
            ...
            var d = this.getPosition(), p = a[0].offsetWidth, u = a[0].offsetHeight;
            if (l) {
                var c = s, h = this.$element.parent(), f = this.getPosition(h);
                s = "bottom" == s && d.top + d.height + u - f.scroll > f.height ? "top" : "top" == s && d.top - f.scroll - u < 0 ? "bottom" : "right" == s && d.right + p > f.width ? "left" : "left" == s && d.left - p < f.left ? "right" : s, a.removeClass(c).addClass(s)
            }
        ...
        var i = this.tip(), a = i[0].offsetWidth, r = i[0].offsetHeight, s = parseInt(i.css("margin-top"), 10),
        ...
        var u = p.left ? 2 * p.left - a + l : 2 * p.top - r + d, c = p.left ? "left" : "top",
        ...
        var n = this, i = this.tip(), a = e.Event("hide.bs." + this.type);
        return this.$element.removeAttr("aria-describedby"), this.$element.trigger(a), a.isDefaultPrevented() ? void 0 : (i.removeClass("in"), e.support.transition && this.$tip.hasClass("fade") ? i.one("bsTransitionEnd", t).emulateTransitionEnd(150) : t(), this.hoverState = null, this)
        ...
        if (/right|left/.test(e)) {
            var o = t.top - r - s.scroll, l = t.top + r - s.scroll + i;
            o < s.top ? a.top = s.top - o : l > s.top + s.height && (a.top = s.top + s.height - l)
        } else {
            var d = t.left - r, p = t.left + r + n;
    ...
    t.VERSION = "3.2.0", t.DEFAULTS = {offset: 10}, t.prototype.getScrollHeight = function () {
        ...
        this.$body.find(this.selector).map(function () {
            var i = e(this), a = i.data("target") || i.attr("href"), r = /^#./.test(a) && e(a);
        ...
        var e, t = this.$scrollElement.scrollTop() + this.options.offset, n = this.getScrollHeight(),
            i = this.options.offset + n - this.$scrollElement.height(), a = this.offsets, r = this.targets,
            s = this.activeTarget;
        if (this.scrollHeight != n && this.refresh(), t >= i) return s != (e = r[r.length - 1]) && this.activate(e);
        if (s && t <= a[0]) return s != (e = r[0]) && this.activate(e);
    ...
    n.VERSION = "3.2.0", n.prototype.show = function () {
        ...
        if (i || (i = t.attr("href"), i = i && i.replace(/.*(?=#[^\s]*$)/, "")), !t.parent("li").hasClass("active")) {
            var a = n.find(".active:last a")[0], r = e.Event("show.bs.tab", {relatedTarget: a});
            if (t.trigger(r), !r.isDefaultPrevented()) {
                var s = e(i);
                this.activate(t.closest("li"), n), this.activate(s, s.parent(), function () {
                    t.trigger({type: "shown.bs.tab", relatedTarget: a})
                })
            }
        }
    ...
    n.VERSION = "3.2.0", n.RESET = "affix affix-top affix-bottom", n.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            var t = e(document).height(), i = this.$target.scrollTop(), a = this.$element.offset(),
                r = this.options.offset, s = r.top, o = r.bottom;
            ...
            if (this.affixed !== l) {
                ...
                var d = "affix" + (l ? "-" + l : ""), p = e.Event(d + ".bs.affix");
                this.$element.trigger(p), p.isDefaultPrevented() || (this.affixed = l, this.unpin = "bottom" == l ? this.getPinnedOffset() : null, this.$element.removeClass(n.RESET).addClass(d).trigger(e.Event(d.replace("affix", "affixed"))), "bottom" == l && this.$element.offset({top: t - this.$element.height() - o}))
            }
        }
    };
    var i = e.fn.affix;
    ...
    return i.defaults = {axis: "xy", duration: 0, limit: !0}, e.fn.scrollTo = function (a, r, s) {
        "object" == typeof r && (s = r, r = 0), "function" == typeof s && (s = {onAfter: s}), "max" === a && (a = 9e9), s = e.extend({}, i.defaults, s), r = r || s.duration;
        var o = s.queue && s.axis.length > 1;
        return o && (r /= 2), s.offset = n(s.offset), s.over = n(s.over), this.each(function () {
            function l(t) {
                var n = e.extend({}, s, {
            ...
            if (null !== a) {
                ...
                e.each(s.axis.split(""), function (e, t) {
                    var n = "x" === t ? "Left" : "Top", a = n.toLowerCase(), r = "scroll" + n, g = c[r](),
                        v = i.max(u, t);
                    if (d) f[r] = d[a] + (p ? 0 : g - c.offset()[a]), s.margin && (f[r] -= parseInt(h.css("margin" + n), 10) || 0, f[r] -= parseInt(h.css("border" + n + "Width"), 10) || 0), f[r] += m[a] || 0, s.over[a] && (f[r] += h["x" === t ? "width" : "height"]() * s.over[a]); else {
                        var y = h[a];
                        f[r] = y.slice && "%" === y.slice(-1) ? parseFloat(y) / 100 * v : y
                    }
                    s.limit && /^\d+$/.test(f[r]) && (f[r] = f[r] <= 0 ? 0 : Math.min(f[r], v)), !e && s.axis.length > 1 && (g === f[r] ? f = {} : o && (l(s.onAfterFirst), f = {}))
                }), l(s.onAfter)
            }
        })
    }, i.max = function (n, i) {
        var a = "x" === i ? "Width" : "Height", r = "scroll" + a;
        if (!t(n)) return n[r] - e(n)[a.toLowerCase()]();
        var s = "client" + a, o = n.ownerDocument || n.document, l = o.documentElement, d = o.body;
...
var scrollme = function (e) {
    ...
    return t.body_height = 0, t.viewport_height = 0, t.viewport_top = 0, t.viewport_bottom = 0, t.viewport_top_previous = -1, t.elements = [], t.elements_in_view = [], t.property_defaults = {
        ...
        return t.init_if() ? (t.init_elements(), t.on_resize(), i.on("resize orientationchange", function () {
            t.on_resize()
        }), i.load(function () {
            setTimeout(function () {
                t.on_resize()
        ...
        e(t.scrollme_selector).each(function () {
            ...
            e(this).find(t.animateme_selector).addBack(t.animateme_selector).each(function () {
                var n = {};
                n.element = e(this), n.when = n.element.data("when"), n.from = n.element.data("from"), n.to = n.element.data("to"), n.element.is("[data-crop]") ? n.crop = n.element.data("crop") : n.crop = !0, n.element.is("[data-easing]") ? n.easing = t.easing_functions[n.element.data("easing")] : n.easing = t.easing_functions.easeout;
                var a = {};
                n.element.is("[data-opacity]") && (a.opacity = n.element.data("opacity")), n.element.is("[data-translatex]") && (a.translatex = n.element.data("translatex")), n.element.is("[data-translatey]") && (a.translatey = n.element.data("translatey")), n.element.is("[data-translatez]") && (a.translatez = n.element.data("translatez")), n.element.is("[data-rotatex]") && (a.rotatex = n.element.data("rotatex")), n.element.is("[data-rotatey]") && (a.rotatey = n.element.data("rotatey")), n.element.is("[data-rotatez]") && (a.rotatez = n.element.data("rotatez")), n.element.is("[data-scale]") && (a.scale = n.element.data("scale")), n.element.is("[data-scalex]") && (a.scalex = n.element.data("scalex")), n.element.is("[data-scaley]") && (a.scaley = n.element.data("scaley")), n.element.is("[data-scalez]") && (a.scalez = n.element.data("scalez")), n.properties = a, i.push(n)
            }), n.effects = i, t.elements.push(n)
        })
    }, t.update = function () {
        ...
        for (var e = t.elements_in_view.length, n = 0; e > n; n++) for (var i = t.elements_in_view[n], a = i.effects.length, r = 0; a > r; r++) {
            var s = i.effects[r];
            switch (s.when) {
                case"view":
                case"span":
                    var o = i.top - t.viewport_height, l = i.bottom;
                    break;
                case"exit":
                    var o = i.bottom - t.viewport_height, l = i.bottom;
                    break;
                default:
                    var o = i.top - t.viewport_height, l = i.top
            }
            s.crop && (0 > o && (o = 0), l > t.body_height - t.viewport_height && (l = t.body_height - t.viewport_height));
            var d = (t.viewport_top - o) / (l - o), p = s.from, u = s.to, c = u - p, h = (d - p) / c, f = s.easing(h),
                m = t.animate_value(d, f, p, u, s, "opacity"), g = t.animate_value(d, f, p, u, s, "translatey"),
                v = t.animate_value(d, f, p, u, s, "translatex"), y = t.animate_value(d, f, p, u, s, "translatez"),
                w = t.animate_value(d, f, p, u, s, "rotatex"), b = t.animate_value(d, f, p, u, s, "rotatey"),
                x = t.animate_value(d, f, p, u, s, "rotatez"), T = t.animate_value(d, f, p, u, s, "scale"),
                C = t.animate_value(d, f, p, u, s, "scalex"), S = t.animate_value(d, f, p, u, s, "scaley"),
                E = t.animate_value(d, f, p, u, s, "scalez");
            "scale" in s.properties && (C = T, S = T, E = T), s.element.css({
                opacity: m,
        ...
        if (!(s in r.properties)) return o;
        var l = r.properties[s], d = a > i ? !0 : !1;
        if (i > e && d) return o;
        if (e > a && d) return l;
        if (e > i && !d) return o;
        if (a > e && !d) return l;
        ...
        t.viewport_top = i.scrollTop(), t.viewport_bottom = t.viewport_top + t.viewport_height
    }, t.update_elements_in_view = function () {
        t.elements_in_view = [];
        for (var e = t.elements.length, n = 0; e > n; n++) t.elements[n].top < t.viewport_bottom && t.elements[n].bottom > t.viewport_top && t.elements_in_view.push(t.elements[n])
        ...
        t.body_height = n.height(), t.viewport_height = i.height()
    }, t.update_element_heights = function () {
        for (var e = t.elements.length, n = 0; e > n; n++) {
            var i = t.elements[n].element.outerHeight(), a = t.elements[n].element.offset();
            t.elements[n].height = i, t.elements[n].top = a.top, t.elements[n].bottom = a.top + i
        }
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    $(".b-top-block").width(e), $(".b-top-block").height(t), $("canvas").width(e), $("canvas").height(t), $(window).resize(function () {
        var e = $(window).width(), t = $(window).height();
        $(".b-top-block").width(e), $(".b-top-block").height(t), $("canvas").width(e), $("canvas").height(t)
    })
}), !function () {
    "use strict";
    var e, t = function (i, a) {
        ...
        function d(e) {
            ...
            if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                if (37 === t || 39 === t || 38 === t || 40 === t) {
                    ...
                    var i = {left: window.pageXOffset, top: window.pageYOffset}, a = window.innerWidth,
                        r = window.innerHeight, s = x.container.offset();
            ...
            if (0 !== t) {
                if (x.params.mousewheelInvert && (t = -t), x.params.freeMode) {
                    var a = x.getWrapperTranslate() + t * x.params.mousewheelSensitivity, r = x.isBeginning,
                        s = x.isEnd;
                    if (a >= x.minTranslate() && (a = x.minTranslate()), a <= x.maxTranslate() && (a = x.maxTranslate()), x.setWrapperTransition(0), x.setWrapperTranslate(a), x.updateProgress(), x.updateActiveIndex(), (!r && x.isBeginning || !s && x.isEnd) && x.updateClasses(), x.params.freeModeSticky ? (clearTimeout(x.mousewheel.timeout), x.mousewheel.timeout = setTimeout(function () {
                        x.slideReset()
                    ...
                    if ((new window.Date).getTime() - x.mousewheel.lastScrollTime > 60) if (0 > t) if (x.isEnd && !x.params.loop || x.animating) {
        ...
        function c(t, n) {
            ...
            i = t.attr("data-swiper-parallax") || "0", a = t.attr("data-swiper-parallax-x"), r = t.attr("data-swiper-parallax-y"), a || r ? (a = a || "0", r = r || "0") : x.isHorizontal() ? (a = i, r = "0") : (r = i, a = "0"), a = a.indexOf("%") >= 0 ? parseInt(a, 10) * n * s + "%" : a * n * s + "px", r = r.indexOf("%") >= 0 ? parseInt(r, 10) * n + "%" : r * n + "px", t.transform("translate3d(" + a + ", " + r + ",0px)")
        }
        ...
        a = a || {};
        var g = {};
        for (var v in a) if ("object" != typeof a[v] || null === a[v] || a[v].nodeType || a[v] === window || a[v] === document || void 0 !== n && a[v] instanceof n || "undefined" != typeof jQuery && a[v] instanceof jQuery) g[v] = a[v]; else {
            g[v] = {};
            for (var y in a[v]) g[v][y] = a[v][y]
        }
        for (var w in f) if (void 0 === a[w]) a[w] = f[w]; else if ("object" == typeof a[w]) for (var b in f[w]) void 0 === a[w][b] && (a[w][b] = f[w][b]);
        var x = this;
        if (x.params = a, x.originalParams = g, x.classNames = [], void 0 !== e && void 0 !== n && (e = n), (void 0 !== e || (e = void 0 === n ? window.Dom7 || window.Zepto || window.jQuery : n)) && (x.$ = e, x.currentBreakpoint = void 0, x.getActiveBreakpoint = function () {
            ...
            x.container[0].swiper = x, x.container.data("swiper", x), x.classNames.push(x.params.containerModifierClass + x.params.direction), x.params.freeMode && x.classNames.push(x.params.containerModifierClass + "free-mode"), x.support.flexbox || (x.classNames.push(x.params.containerModifierClass + "no-flexbox"), x.params.slidesPerColumn = 1), x.params.autoHeight && x.classNames.push(x.params.containerModifierClass + "autoheight"), (x.params.parallax || x.params.watchSlidesVisibility) && (x.params.watchSlidesProgress = !0), x.params.touchReleaseOnEdges && (x.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(x.params.effect) >= 0 && (x.support.transforms3d ? (x.params.watchSlidesProgress = !0, x.classNames.push(x.params.containerModifierClass + "3d")) : x.params.effect = "slide"), "slide" !== x.params.effect && x.classNames.push(x.params.containerModifierClass + x.params.effect), "cube" === x.params.effect && (x.params.resistanceRatio = 0, x.params.slidesPerView = 1, x.params.slidesPerColumn = 1, x.params.slidesPerGroup = 1, x.params.centeredSlides = !1, x.params.spaceBetween = 0, x.params.virtualTranslate = !0), "fade" !== x.params.effect && "flip" !== x.params.effect || (x.params.slidesPerView = 1, x.params.slidesPerColumn = 1, x.params.slidesPerGroup = 1, x.params.watchSlidesProgress = !0, x.params.spaceBetween = 0, void 0 === m && (x.params.virtualTranslate = !0)), x.params.grabCursor && x.support.touch && (x.params.grabCursor = !1), x.wrapper = x.container.children("." + x.params.wrapperClass), x.params.pagination && (x.paginationContainer = e(x.params.pagination), x.params.uniqueNavElements && "string" == typeof x.params.pagination && x.paginationContainer.length > 1 && 1 === x.container.find(x.params.pagination).length && (x.paginationContainer = x.container.find(x.params.pagination)), "bullets" === x.params.paginationType && x.params.paginationClickable ? x.paginationContainer.addClass(x.params.paginationModifierClass + "clickable") : x.params.paginationClickable = !1, x.paginationContainer.addClass(x.params.paginationModifierClass + x.params.paginationType)), (x.params.nextButton || x.params.prevButton) && (x.params.nextButton && (x.nextButton = e(x.params.nextButton), x.params.uniqueNavElements && "string" == typeof x.params.nextButton && x.nextButton.length > 1 && 1 === x.container.find(x.params.nextButton).length && (x.nextButton = x.container.find(x.params.nextButton))), x.params.prevButton && (x.prevButton = e(x.params.prevButton), x.params.uniqueNavElements && "string" == typeof x.params.prevButton && x.prevButton.length > 1 && 1 === x.container.find(x.params.prevButton).length && (x.prevButton = x.container.find(x.params.prevButton)))), x.isHorizontal = function () {
            ...
            }, x.params.grabCursor && x.setGrabCursor(), x.imagesToLoad = [], x.imagesLoaded = 0, x.loadImage = function (e, t, n, i, a, r) {
                function s() {
                    r && r()
                }
                ...
                return void 0 === x.autoplayTimeoutId && !!x.params.autoplay && !x.autoplaying && (x.autoplaying = !0, x.emit("onAutoplayStart", x), void s())
                ...
                if (void 0 !== x.size) {
                    ...
                    var o, l = x.params.slidesPerColumn, d = s / l,
                    ...
                    for (e = 0; e < x.slides.length; e++) {
                        ...
                        if (x.params.slidesPerColumn > 1) {
                            var c, h, f;
                            "column" === x.params.slidesPerColumnFill ? (h = Math.floor(e / l), f = e - h * l, (h > p || h === p && f === l - 1) && ++f >= l && (f = 0, h++), c = h + f * s / l, u.css({
                                "-webkit-box-ordinal-group": c,
                                "-moz-box-ordinal-group": c,
                                "-ms-flex-order": c,
                                "-webkit-order": c,
                                order: c
                            })) : (f = Math.floor(e / d), h = e - f * d), u.css("margin-" + (x.isHorizontal() ? "top" : "left"), 0 !== f && x.params.spaceBetween && x.params.spaceBetween + "px").attr("data-swiper-column", h).attr("data-swiper-row", f)
                        }
                        "none" !== u.css("display") && ("auto" === x.params.slidesPerView ? (o = x.isHorizontal() ? u.outerWidth(!0) : u.outerHeight(!0), x.params.roundLengths && (o = r(o))) : (o = (x.size - (x.params.slidesPerView - 1) * t) / x.params.slidesPerView, x.params.roundLengths && (o = r(o)), x.isHorizontal() ? x.slides[e].style.width = o + "px" : x.slides[e].style.height = o + "px"), x.slides[e].swiperSlideSize = o, x.slidesSizesGrid.push(o), x.params.centeredSlides ? (n = n + o / 2 + i / 2 + t, 0 === i && 0 !== e && (n = n - x.size / 2 - t), 0 === e && (n = n - x.size / 2 - t), Math.abs(n) < .001 && (n = 0), a % x.params.slidesPerGroup == 0 && x.snapGrid.push(n), x.slidesGrid.push(n)) : (a % x.params.slidesPerGroup == 0 && x.snapGrid.push(n), x.slidesGrid.push(n), n = n + o + t), x.virtualSize += o + t, i = o, a++)
                    }
                ...
                if (x.params.centeredSlides) {
                    ...
                    for (e = x.activeIndex + 1; e < x.slides.length; e++) x.slides[e] && !i && (a += x.slides[e].swiperSlideSize, n++, a > x.size && (i = !0));
                    for (t = x.activeIndex - 1; t >= 0; t--) x.slides[t] && !i && (a += x.slides[t].swiperSlideSize, n++, a > x.size && (i = !0))
                ...
                if (void 0 === e && (e = x.translate || 0), 0 !== x.slides.length) {
                    ...
                    for (var n = 0; n < x.slides.length; n++) {
                        ...
                        if (x.params.watchSlidesVisibility) {
                            var r = -(t - i.swiperSlideOffset), s = r + x.slidesSizesGrid[n];
                ...
                var t = x.maxTranslate() - x.minTranslate(), n = x.isBeginning, i = x.isEnd;
                ...
                for (t = 0; t < x.slidesGrid.length; t++) void 0 !== x.slidesGrid[t + 1] ? i >= x.slidesGrid[t] && i < x.slidesGrid[t + 1] - (x.slidesGrid[t + 1] - x.slidesGrid[t]) / 2 ? e = t : i >= x.slidesGrid[t] && i < x.slidesGrid[t + 1] && (e = t + 1) : i >= x.slidesGrid[t] && (e = t);
                x.params.normalizeSlideIndex && (0 > e || void 0 === e) && (e = 0), n = Math.floor(e / x.params.slidesPerGroup), n >= x.snapGrid.length && (n = x.snapGrid.length - 1), e !== x.activeIndex && (x.snapIndex = n, x.previousIndex = x.activeIndex, x.activeIndex = e, x.updateClasses(), x.updateRealIndex())
                ...
                if (x.params.loop && 0 === i.length && (i = x.slides.eq(-1), i.addClass(x.params.slidePrevClass)), a.loop && (n.hasClass(x.params.slideDuplicateClass) ? x.wrapper.children("." + x.params.slideClass + ":not(." + x.params.slideDuplicateClass + ')[data-swiper-slide-index="' + n.attr("data-swiper-slide-index") + '"]').addClass(x.params.slideDuplicateNextClass) : x.wrapper.children("." + x.params.slideClass + "." + x.params.slideDuplicateClass + '[data-swiper-slide-index="' + n.attr("data-swiper-slide-index") + '"]').addClass(x.params.slideDuplicateNextClass), i.hasClass(x.params.slideDuplicateClass) ? x.wrapper.children("." + x.params.slideClass + ":not(." + x.params.slideDuplicateClass + ')[data-swiper-slide-index="' + i.attr("data-swiper-slide-index") + '"]').addClass(x.params.slideDuplicatePrevClass) : x.wrapper.children("." + x.params.slideClass + "." + x.params.slideDuplicateClass + '[data-swiper-slide-index="' + i.attr("data-swiper-slide-index") + '"]').addClass(x.params.slideDuplicatePrevClass)), x.paginationContainer && x.paginationContainer.length > 0) {
                    var r,
                        s = x.params.loop ? Math.ceil((x.slides.length - 2 * x.loopedSlides) / x.params.slidesPerGroup) : x.snapGrid.length;
                    if (x.params.loop ? (r = Math.ceil((x.activeIndex - x.loopedSlides) / x.params.slidesPerGroup), r > x.slides.length - 1 - 2 * x.loopedSlides && (r -= x.slides.length - 2 * x.loopedSlides), r > s - 1 && (r -= s), 0 > r && "bullets" !== x.params.paginationType && (r = s + r)) : r = void 0 !== x.snapIndex ? x.snapIndex : x.activeIndex || 0, "bullets" === x.params.paginationType && x.bullets && x.bullets.length > 0 && (x.bullets.removeClass(x.params.bulletActiveClass), x.paginationContainer.length > 1 ? x.bullets.each(function () {
                ...
                if (x.params.pagination && x.paginationContainer && x.paginationContainer.length > 0) {
                    ...
                    if ("bullets" === x.params.paginationType) {
                        for (var t = x.params.loop ? Math.ceil((x.slides.length - 2 * x.loopedSlides) / x.params.slidesPerGroup) : x.snapGrid.length, n = 0; t > n; n++) e += x.params.paginationBulletRender ? x.params.paginationBulletRender(x, n, x.params.bulletClass) : "<" + x.params.paginationElement + ' class="' + x.params.bulletClass + '"></' + x.params.paginationElement + ">";
                ...
                x.params.lazyLoading && !i && x.lazy && x.lazy.load(), x.params.allowSwipeToPrev = t, x.params.allowSwipeToNext = n, x.params.onAfterResize && x.params.onAfterResize(x)
                ...
                var t = e ? "off" : "on", n = e ? "removeEventListener" : "addEventListener",
                    ...
                    r = x.support.touch ? i : document, s = !!x.params.nested;
                if (x.browser.ie) i[n](x.touchEvents.start, x.onTouchStart, !1), r[n](x.touchEvents.move, x.onTouchMove, s), r[n](x.touchEvents.end, x.onTouchEnd, !1); else {
                    if (x.support.touch) {
                        var o = !("touchstart" !== x.touchEvents.start || !x.support.passiveListener || !x.params.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        };
                        i[n](x.touchEvents.start, x.onTouchStart, o), i[n](x.touchEvents.move, x.onTouchMove, s), i[n](x.touchEvents.end, x.onTouchEnd, o)
                    }
                    (a.simulateTouch && !x.device.ios && !x.device.android || a.simulateTouch && !x.support.touch && x.device.ios) && (i[n]("mousedown", x.onTouchStart, !1), document[n]("mousemove", x.onTouchMove, s), document[n]("mouseup", x.onTouchEnd, !1))
                }
                ...
                var n = o(t, "." + x.params.slideClass), i = !1;
                if (n) for (var a = 0; a < x.slides.length; a++) x.slides[a] === n && (i = !0);
                ...
                if (x.clickedSlide = n, x.clickedIndex = e(n).index(), x.params.slideToClickedSlide && void 0 !== x.clickedIndex && x.clickedIndex !== x.activeIndex) {
                    ...
                    if (x.params.loop) {
                        ...
                        r = parseInt(e(x.clickedSlide).attr("data-swiper-slide-index"), 10), x.params.centeredSlides ? s < x.loopedSlides - l / 2 || s > x.slides.length - x.loopedSlides + l / 2 ? (x.fixLoop(), s = x.wrapper.children("." + x.params.slideClass + '[data-swiper-slide-index="' + r + '"]:not(.' + x.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function () {
                            x.slideTo(s)
                        }, 0)) : x.slideTo(s) : s > x.slides.length - l ? (x.fixLoop(), s = x.wrapper.children("." + x.params.slideClass + '[data-swiper-slide-index="' + r + '"]:not(.' + x.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function () {
                            x.slideTo(s)
                        }, 0)) : x.slideTo(s)
                    } else x.slideTo(s)
                }
            ...
            x.onTouchStart = function (t) {
                if (t.originalEvent && (t = t.originalEvent), (H = "touchstart" === t.type) || !("which" in t) || 3 !== t.which) {
                    ...
                    if (!x.params.swipeHandler || o(t, x.params.swipeHandler)) {
                        ...
                        if (!(x.device.ios && x.params.iOSEdgeSwipeDetection && n <= x.params.iOSEdgeSwipeThreshold)) {
                            if (C = !0, S = !1, E = !0, M = void 0, O = void 0, x.touches.startX = n, x.touches.startY = i, k = Date.now(), x.allowClick = !0, x.updateContainerSize(), x.swipeDirection = void 0, x.params.threshold > 0 && (N = !1), "touchstart" !== t.type) {
                                var a = !0;
                ...
                if (t.originalEvent && (t = t.originalEvent), !H || "mousemove" !== t.type) {
                    ...
                    if (H && document.activeElement && t.target === document.activeElement && e(t.target).is(A)) return S = !0, void (x.allowClick = !1);
                    if (E && x.emit("onTouchMove", x, t), !(t.targetTouches && t.targetTouches.length > 1)) {
                        ...
                        if (M && x.emit("onTouchMoveOpposite", x, t), void 0 === O && (x.touches.currentX === x.touches.startX && x.touches.currentY === x.touches.startY || (O = !0)), C) {
                            if (M) return void (C = !1);
                            if (O) {
                                x.allowClick = !1, x.emit("onSliderMove", x, t), t.preventDefault(), x.params.touchMoveStopPropagation && !x.params.nested && t.stopPropagation(), S || (a.loop && x.fixLoop(), D = x.getWrapperTranslate(), x.setWrapperTransition(0), x.animating && x.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), x.params.autoplay && x.autoplaying && (x.params.autoplayDisableOnInteraction ? x.stopAutoplay() : x.pauseAutoplay()), P = !1, !x.params.grabCursor || x.params.allowSwipeToNext !== !0 && x.params.allowSwipeToPrev !== !0 || x.setGrabCursor(!0)), S = !0;
                                var i = x.touches.diff = x.isHorizontal() ? x.touches.currentX - x.touches.startX : x.touches.currentY - x.touches.startY;
                                i *= x.params.touchRatio, x.rtl && (i = -i), x.swipeDirection = i > 0 ? "prev" : "next", z = i + D;
                                var r = !0;
                                if (i > 0 && z > x.minTranslate() ? (r = !1, x.params.resistance && (z = x.minTranslate() - 1 + Math.pow(-x.minTranslate() + D + i, x.params.resistanceRatio))) : 0 > i && z < x.maxTranslate() && (r = !1, x.params.resistance && (z = x.maxTranslate() + 1 - Math.pow(x.maxTranslate() - D - i, x.params.resistanceRatio))), r && (t.preventedByNestedSwiper = !0), !x.params.allowSwipeToNext && "next" === x.swipeDirection && D > z && (z = D), !x.params.allowSwipeToPrev && "prev" === x.swipeDirection && z > D && (z = D), x.params.threshold > 0) {
                                    if (!(Math.abs(i) > x.params.threshold || N)) return void (z = D);
                                    if (!N) return N = !0, x.touches.startX = x.touches.currentX, x.touches.startY = x.touches.currentY, z = D, void (x.touches.diff = x.isHorizontal() ? x.touches.currentX - x.touches.startX : x.touches.currentY - x.touches.startY)
                                }
                ...
                if (t.originalEvent && (t = t.originalEvent), E && x.emit("onTouchEnd", x, t), E = !1, C) {
                    x.params.grabCursor && S && C && (x.params.allowSwipeToNext === !0 || x.params.allowSwipeToPrev === !0) && x.setGrabCursor(!1);
                    var n = Date.now(), i = n - k;
                    if (x.allowClick && (x.updateClickedSlide(t), x.emit("onTap", x, t), 300 > i && n - $ > 300 && (L && clearTimeout(L), L = setTimeout(function () {
                    ...
                    }, 300)), 300 > i && 300 > n - $ && (L && clearTimeout(L), x.emit("onDoubleTap", x, t))), $ = Date.now(), setTimeout(function () {
                        x && (x.allowClick = !0)
                    }, 0), !C || !S || !x.swipeDirection || 0 === x.touches.diff || z === D) return void (C = S = !1);
                    C = S = !1;
                    var a;
                    if (a = x.params.followFinger ? x.rtl ? x.translate : -x.translate : -z, x.params.freeMode) {
                        ...
                        if (x.params.freeModeMomentum) {
                            if (I.length > 1) {
                                var r = I.pop(), s = I.pop(), o = r.position - s.position, l = r.time - s.time;
                            ...
                            if (u < x.maxTranslate()) x.params.freeModeMomentumBounce ? (u + x.maxTranslate() < -f && (u = x.maxTranslate() - f), c = x.maxTranslate(), h = !0, P = !0) : u = x.maxTranslate(); else if (u > x.minTranslate()) x.params.freeModeMomentumBounce ? (u - x.minTranslate() > f && (u = x.minTranslate() + f), c = x.minTranslate(), h = !0, P = !0) : u = x.minTranslate(); else if (x.params.freeModeSticky) {
                                var m, g = 0;
                            ...
                            x.params.freeModeMomentumBounce && h ? (x.updateProgress(c), x.setWrapperTransition(d), x.setWrapperTranslate(u), x.onTransitionStart(), x.animating = !0, x.wrapper.transitionEnd(function () {
                    ...
                    for (v = 0; v < x.slidesGrid.length; v += x.params.slidesPerGroup) void 0 !== x.slidesGrid[v + x.params.slidesPerGroup] ? a >= x.slidesGrid[v] && a < x.slidesGrid[v + x.params.slidesPerGroup] && (y = v, w = x.slidesGrid[v + x.params.slidesPerGroup] - x.slidesGrid[v]) : a >= x.slidesGrid[v] && (y = v, w = x.slidesGrid[x.slidesGrid.length - 1] - x.slidesGrid[x.slidesGrid.length - 2]);
                ...
                if (x.params.autoplay && x.autoplaying && (i || !x.params.autoplayDisableOnInteraction ? x.pauseAutoplay(t) : x.stopAutoplay()), x.updateProgress(a), x.params.normalizeSlideIndex) for (var r = 0; r < x.slidesGrid.length; r++) -Math.floor(100 * a) >= Math.floor(100 * x.slidesGrid[r]) && (e = r);
                ...
                var i = 0, a = 0;
                x.isHorizontal() ? i = x.rtl ? -e : e : a = e, x.params.roundLengths && (i = r(i), a = r(a)), x.params.virtualTranslate || (x.support.transforms3d ? x.wrapper.transform("translate3d(" + i + "px, " + a + "px, 0px)") : x.wrapper.transform("translate(" + i + "px, " + a + "px)")), x.translate = x.isHorizontal() ? i : a;
                var s, o = x.maxTranslate() - x.minTranslate();
                s = 0 === o ? 0 : (e - x.minTranslate()) / o, s !== x.progress && x.updateProgress(e), t && x.updateActiveIndex(), "slide" !== x.params.effect && x.effects[x.params.effect] && x.effects[x.params.effect].setTranslate(x.translate), x.params.parallax && x.parallax && x.parallax.setTranslate(x.translate), x.params.scrollbar && x.scrollbar && x.scrollbar.setTranslate(x.translate), x.params.control && x.controller && x.controller.setTranslate(x.translate, n), x.emit("onSetTranslate", x, x.translate)
            }, x.getTranslate = function (e, t) {
                var n, i, a, r;
                return void 0 === t && (t = "x"), x.params.virtualTranslate ? x.rtl ? -x.translate : x.translate : (a = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? (i = a.transform || a.webkitTransform, i.split(",").length > 6 && (i = i.split(", ").map(function (e) {
                    return e.replace(",", ".")
                }).join(", ")), r = new window.WebKitCSSMatrix("none" === i ? "" : i)) : (r = a.MozTransform || a.OTransform || a.MsTransform || a.msTransform || a.transform || a.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), n = r.toString().split(",")), "x" === t && (i = window.WebKitCSSMatrix ? r.m41 : 16 === n.length ? parseFloat(n[12]) : parseFloat(n[4])), "y" === t && (i = window.WebKitCSSMatrix ? r.m42 : 16 === n.length ? parseFloat(n[13]) : parseFloat(n[5])), x.rtl && i && (i = -i), i || 0)
                ...
                for (t.each(function (n, r) {
                    var s = e(this);
                    n < x.loopedSlides && a.push(r), n < t.length && n >= t.length - x.loopedSlides && i.push(r), s.attr("data-swiper-slide-index", n)
                }), n = 0; n < a.length; n++) x.wrapper.append(e(a[n].cloneNode(!0)).addClass(x.params.slideDuplicateClass));
                for (n = i.length - 1; n >= 0; n--) x.wrapper.prepend(e(i[n].cloneNode(!0)).addClass(x.params.slideDuplicateClass))
                ...
                fade: {
                    setTranslate: function () {
                        for (var e = 0; e < x.slides.length; e++) {
                            var t = x.slides.eq(e), n = t[0].swiperSlideOffset, i = -n;
                            x.params.virtualTranslate || (i -= x.translate);
                            var a = 0;
                            x.isHorizontal() || (a = i, i = 0);
                    ...
                    setTranslate: function () {
                        for (var t = 0; t < x.slides.length; t++) {
                            var n = x.slides.eq(t), i = n[0].progress;
                            x.params.flip.limitRotation && (i = Math.max(Math.min(n[0].progress, 1), -1));
                            var a = n[0].swiperSlideOffset, r = -180 * i, s = r, o = 0, l = -a, d = 0;
                            if (x.isHorizontal() ? x.rtl && (s = -s) : (d = l, l = 0, o = -s, s = 0), n[0].style.zIndex = -Math.abs(Math.round(i)) + x.slides.length, x.params.flip.slideShadows) {
                                ...
                                0 === p.length && (p = e('<div class="swiper-slide-shadow-' + (x.isHorizontal() ? "left" : "top") + '"></div>'), n.append(p)), 0 === u.length && (u = e('<div class="swiper-slide-shadow-' + (x.isHorizontal() ? "right" : "bottom") + '"></div>'), n.append(u)), p.length && (p[0].style.opacity = Math.max(-i, 0)), u.length && (u[0].style.opacity = Math.max(i, 0))
                            }
                    ...
                    setTranslate: function () {
                        ...
                        for (var i = 0; i < x.slides.length; i++) {
                            var a = x.slides.eq(i), r = 90 * i, s = Math.floor(r / 360);
                            x.rtl && (r = -r, s = Math.floor(-r / 360));
                            var o = Math.max(Math.min(a[0].progress, 1), -1), l = 0, d = 0, p = 0;
                            i % 4 == 0 ? (l = 4 * -s * x.size, p = 0) : (i - 1) % 4 == 0 ? (l = 0, p = 4 * -s * x.size) : (i - 2) % 4 == 0 ? (l = x.size + 4 * s * x.size, p = x.size) : (i - 3) % 4 == 0 && (l = -x.size, p = 3 * x.size + 4 * x.size * s), x.rtl && (l = -l), x.isHorizontal() || (d = l, l = 0);
                            var u = "rotateX(" + (x.isHorizontal() ? 0 : -r) + "deg) rotateY(" + (x.isHorizontal() ? r : 0) + "deg) translate3d(" + l + "px, " + d + "px, " + p + "px)";
                            if (1 >= o && o > -1 && (n = 90 * i + 90 * o, x.rtl && (n = 90 * -i - 90 * o)), a.transform(u), x.params.cube.slideShadows) {
                                ...
                                0 === c.length && (c = e('<div class="swiper-slide-shadow-' + (x.isHorizontal() ? "left" : "top") + '"></div>'), a.append(c)), 0 === h.length && (h = e('<div class="swiper-slide-shadow-' + (x.isHorizontal() ? "right" : "bottom") + '"></div>'), a.append(h)), c.length && (c[0].style.opacity = Math.max(-o, 0)), h.length && (h[0].style.opacity = Math.max(o, 0))
                            }
                        }
                        if (x.wrapper.css({
                    ...
                    setTranslate: function () {
                        for (var t = x.translate, n = x.isHorizontal() ? -t + x.width / 2 : -t + x.height / 2, i = x.isHorizontal() ? x.params.coverflow.rotate : -x.params.coverflow.rotate, a = x.params.coverflow.depth, r = 0, s = x.slides.length; s > r; r++) {
                            var o = x.slides.eq(r), l = x.slidesSizesGrid[r], d = o[0].swiperSlideOffset,
                                p = (n - d - l / 2) / l * x.params.coverflow.modifier, u = x.isHorizontal() ? i * p : 0,
                                c = x.isHorizontal() ? 0 : i * p, h = -a * Math.abs(p),
                                f = x.isHorizontal() ? 0 : x.params.coverflow.stretch * p,
                                m = x.isHorizontal() ? x.params.coverflow.stretch * p : 0;
                            Math.abs(m) < .001 && (m = 0), Math.abs(f) < .001 && (f = 0), Math.abs(h) < .001 && (h = 0), Math.abs(u) < .001 && (u = 0), Math.abs(c) < .001 && (c = 0);
                            var g = "translate3d(" + m + "px," + f + "px," + h + "px)  rotateX(" + c + "deg) rotateY(" + u + "deg)";
                            if (o.transform(g), o[0].style.zIndex = 1 - Math.abs(Math.round(p)), x.params.coverflow.slideShadows) {
                                ...
                                0 === v.length && (v = e('<div class="swiper-slide-shadow-' + (x.isHorizontal() ? "left" : "top") + '"></div>'), o.append(v)), 0 === y.length && (y = e('<div class="swiper-slide-shadow-' + (x.isHorizontal() ? "right" : "bottom") + '"></div>'), o.append(y)), v.length && (v[0].style.opacity = p > 0 ? p : 0), y.length && (y[0].style.opacity = -p > 0 ? -p : 0)
                            }
                        }
                ...
                initialImageLoaded: !1, loadImageInSlide: function (t, n) {
                    if (void 0 !== t && (void 0 === n && (n = !0), 0 !== x.slides.length)) {
                        ...
                        !i.hasClass(x.params.lazyLoadingClass) || i.hasClass(x.params.lazyStatusLoadedClass) || i.hasClass(x.params.lazyStatusLoadingClass) || (a = a.add(i[0])), 0 !== a.length && a.each(function () {
                            var t = e(this);
                            t.addClass(x.params.lazyStatusLoadingClass);
                            var a = t.attr("data-background"), r = t.attr("data-src"), s = t.attr("data-srcset"),
                                o = t.attr("data-sizes");
                            x.loadImage(t[0], r || a, s, o, !1, function () {
                                if (void 0 !== x && null !== x && x) {
                                    if (a ? (t.css("background-image", 'url("' + a + '")'), t.removeAttr("data-background")) : (s && (t.attr("srcset", s), t.removeAttr("data-srcset")), o && (t.attr("sizes", o), t.removeAttr("data-sizes")), r && (t.attr("src", r), t.removeAttr("data-src"))), t.addClass(x.params.lazyStatusLoadedClass).removeClass(x.params.lazyStatusLoadingClass), i.find("." + x.params.lazyPreloaderClass + ", ." + x.params.preloaderClass).remove(), x.params.loop && n) {
                    ...
                    if (x.params.lazyLoadingInPrevNext) if (n > 1 || x.params.lazyLoadingInPrevNextAmount && x.params.lazyLoadingInPrevNextAmount > 1) {
                        var i = x.params.lazyLoadingInPrevNextAmount, a = n,
                            r = Math.min(x.activeIndex + a + Math.max(i, a), x.slides.length),
                            s = Math.max(x.activeIndex - Math.max(a, i), 0);
                        for (t = x.activeIndex + n; r > t; t++) x.slides[t] && x.lazy.loadImageInSlide(t);
                ...
                isTouched: !1, setDragPosition: function (e) {
                    ...
                    a > i ? i = a : i > r && (i = r), i = -i / t.moveDivider, x.updateProgress(i), x.setWrapperTranslate(i, !0)
                ...
                onHashCange: function (e, t) {
                    ...
                    if (x.params.hashnav && !x.params.history) {
                        ...
                        if (e) for (var t = 0, n = x.slides.length; n > t; t++) {
                            var i = x.slides.eq(t), a = i.attr("data-hash") || i.attr("data-history");
                ...
                init: function () {
                    ...
                    if (x.history.initialized && x.params.history) {
                        var n = x.slides.eq(t), i = this.slugify(n.attr("data-history"));
                    ...
                    if (t) for (var i = 0, a = x.slides.length; a > i; i++) {
                        var r = x.slides.eq(i), s = this.slugify(r.attr("data-history"));
                ...
                onGestureStart: function (t) {
                    ...
                    return n.gesture.slide && n.gesture.slide.length || (n.gesture.slide = e(this), 0 === n.gesture.slide.length && (n.gesture.slide = x.slides.eq(x.activeIndex)), n.gesture.image = n.gesture.slide.find("img, svg, canvas"), n.gesture.imageWrap = n.gesture.image.parent("." + x.params.zoomContainerClass), n.gesture.zoomMax = n.gesture.imageWrap.attr("data-swiper-zoom") || x.params.zoomMax, 0 !== n.gesture.imageWrap.length) ? (n.gesture.image.transition(0), void (n.isScaling = !0)) : void (n.gesture.image = void 0)
                },
                ...
                onTouchEnd: function (e, t) {
                    ...
                    if (n.gesture.image && 0 !== n.gesture.image.length) {
                        ...
                        var i = 300, a = 300, r = n.velocity.x * i, s = n.image.currentX + r, o = n.velocity.y * a,
                        ...
                        var p = n.image.width * n.scale, u = n.image.height * n.scale;
                        n.image.minX = Math.min(n.gesture.slideWidth / 2 - p / 2, 0), n.image.maxX = -n.image.minX, n.image.minY = Math.min(n.gesture.slideHeight / 2 - u / 2, 0), n.image.maxY = -n.image.minY, n.image.currentX = Math.max(Math.min(n.image.currentX, n.image.maxX), n.image.minX), n.image.currentY = Math.max(Math.min(n.image.currentY, n.image.maxY), n.image.minY), n.gesture.imageWrap.transition(d).transform("translate3d(" + n.image.currentX + "px, " + n.image.currentY + "px,0)")
                    }
                },
    ...
    for (var n = (function () {
        ...
        return e.prototype = {
            addClass: function (e) {
                ...
                function r(e) {
                    var a = e.target;
                    if (t(a).is(n)) i.call(a, e); else for (var r = t(a).parents(), s = 0; s < r.length; s++) t(r[s]).is(n) && i.call(r[s], e)
                }

                var s, o, l = e.split(" ");
                for (s = 0; s < this.length; s++) if ("function" == typeof n || n === !1) for ("function" == typeof n && (i = arguments[1], a = arguments[2] || !1), o = 0; o < l.length; o++) this[s].addEventListener(l[o], i, a); else for (o = 0; o < l.length; o++) this[s].dom7LiveListeners || (this[s].dom7LiveListeners = []), this[s].dom7LiveListeners.push({
                    listener: i,
                    liveListener: r
                }), this[s].addEventListener(l[o], r, a);
                return this
            }, off: function (e, t, n, i) {
                for (var a = e.split(" "), r = 0; r < a.length; r++) for (var s = 0; s < this.length; s++) if ("function" == typeof t || t === !1) "function" == typeof t && (n = arguments[1], i = arguments[2] || !1), this[s].removeEventListener(a[r], n, i); else if (this[s].dom7LiveListeners) for (var o = 0; o < this[s].dom7LiveListeners.length; o++) this[s].dom7LiveListeners[o].listener === n && this[s].removeEventListener(a[r], this[s].dom7LiveListeners[o].liveListener, i);
                return this
                ...
                if (this.length > 0) {
                    var e = this[0], t = e.getBoundingClientRect(), n = document.body,
                        i = e.clientTop || n.clientTop || 0, a = e.clientLeft || n.clientLeft || 0,
                        r = window.pageYOffset || e.scrollTop, s = window.pageXOffset || e.scrollLeft;
                ...
                for (var i = [], a = 0; a < this.length; a++) for (var r = this[a].childNodes, s = 0; s < r.length; s++) n ? 1 === r[s].nodeType && t(r[s]).is(n) && i.push(r[s]) : 1 === r[s].nodeType && i.push(r[s]);
    ...
    $(function () {
        var e, t, n, i, a, r;
        return e = $(".js-header-menu"), a = 0, i = function () {
            var e;
            return e = 0, $(window).scroll(function () {
                var t;
                return t = $(this).scrollTop(), t > e ? $(".img_menu").css("opacity", "0") : $(".img_menu").css("opacity", "1"), e = t
            })
        }, r = function (e) {
            return $(".js-header-menu-button").css({"pointer-events": "none"}), a = $(window).scrollTop(), $(".l-header__logo.l-header__logo__image").css("opacity", "0"), $(".l-header__menu").addClass("mobile-popup"), $(".img_menu").css("opacity", "1"), $(e.currentTarget).removeClass("close").addClass("open"), setTimeout(function () {
                return $("body").css({overflow: "hidden", position: "fixed", top: -a})
            }, 700), setTimeout(function () {
                return $(".js-header-menu-button").css({"pointer-events": "auto"})
            }, 1600)
        }, t = function (t) {
            return $(".js-header-menu-button").css({"pointer-events": "none"}), $(".l-header__logo.l-header__logo__image").css("opacity", "1"), e.find(".js-header-menu-button").removeClass("open").addClass("close"), $("body").css({
                overflow: "",
                position: "",
                top: ""
            }), $(window).scrollTop(a), setTimeout(function () {
                return $(".l-header__menu").removeClass("mobile-popup")
            }, 700), setTimeout(function () {
                return $(".js-header-menu-button").css({"pointer-events": "auto"})
            }, 1600)
        }, n = function (e) {
            return $(".current").removeClass("current"), $(e.currentTarget).addClass("current")
        }, e.on("click", ".js-header-menu-button.close", r), e.on("click", ".js-header-menu-button.open", t), e.on("click", ".js-scroll-to", t), e.on("click", ".js-landing-link", n), i()
    })
}.call(this), function () {
    $(function () {
        var e;
